...
.method static synthetic access$1000(Lb/i;)I
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .prologue
    .line 131
    invoke-static {p0}, Lcom/squareup/okhttp/Cache;->readInt(Lb/i;)I
...
.method private static readInt(Lb/i;)I
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 660
    :try_start_0
    invoke-interface {p0}, Lb/i;->n()J

    move-result-wide v0

    .line 661
    invoke-interface {p0}, Lb/i;->r()Ljava/lang/String;
...
.method get(Lcom/squareup/okhttp/Request;)Lcom/squareup/okhttp/Response;
    ...
    invoke-virtual {v1, v3}, Lcom/squareup/okhttp/internal/DiskLruCache$Snapshot;->getSource(I)Lb/ac;

    move-result-object v3

    invoke-direct {v2, v3}, Lcom/squareup/okhttp/Cache$Entry;-><init>(Lb/ac;)V
    :try_end_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_0
