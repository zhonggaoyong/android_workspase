.class public Lcom/fanli/android/view/MainPage/JustifyTextView;
...
.method private drawScaledText(Landroid/graphics/Canvas;ILjava/lang/String;F)V
    ...
    .line 60
    .local v6, "x":F
    invoke-direct {p0, p2, p3}, Lcom/fanli/android/view/MainPage/JustifyTextView;->isFirstLineOfParagraph(ILjava/lang/String;)Z
    ...
    iget v7, p0, Lcom/fanli/android/view/MainPage/JustifyTextView;->mLineY:I

    int-to-float v7, v7

    invoke-virtual {p0}, Lcom/fanli/android/view/MainPage/JustifyTextView;->getPaint()Landroid/text/TextPaint;
    ...
    .end local v1    # "bw":F
    :cond_0
    iget v7, p0, Lcom/fanli/android/view/MainPage/JustifyTextView;->mViewWidth:I
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {p0}, Lcom/fanli/android/view/MainPage/JustifyTextView;->getCurrentTextColor()I
    ...
    .line 34
    invoke-virtual {p0}, Lcom/fanli/android/view/MainPage/JustifyTextView;->getDrawableState()[I
    ...
    .line 35
    invoke-virtual {p0}, Lcom/fanli/android/view/MainPage/JustifyTextView;->getMeasuredWidth()I

    move-result v8

    iput v8, p0, Lcom/fanli/android/view/MainPage/JustifyTextView;->mViewWidth:I

    .line 36
    invoke-virtual {p0}, Lcom/fanli/android/view/MainPage/JustifyTextView;->getText()Ljava/lang/CharSequence;
    ...
    iput v8, p0, Lcom/fanli/android/view/MainPage/JustifyTextView;->mLineY:I

    .line 38
    iget v8, p0, Lcom/fanli/android/view/MainPage/JustifyTextView;->mLineY:I

    int-to-float v8, v8

    invoke-virtual {p0}, Lcom/fanli/android/view/MainPage/JustifyTextView;->getTextSize()F
    ...
    .line 39
    invoke-virtual {p0}, Lcom/fanli/android/view/MainPage/JustifyTextView;->getLayout()Landroid/text/Layout;
    ...
    .line 47
    .local v7, "width":F
    invoke-direct {p0, v2}, Lcom/fanli/android/view/MainPage/JustifyTextView;->needScale(Ljava/lang/String;)Z
    ...
    .line 48
    invoke-direct {p0, p1, v4, v2, v7}, Lcom/fanli/android/view/MainPage/JustifyTextView;->drawScaledText(Landroid/graphics/Canvas;ILjava/lang/String;F)V

    .line 53
    :goto_1
    iget v8, p0, Lcom/fanli/android/view/MainPage/JustifyTextView;->mLineY:I

    invoke-virtual {p0}, Lcom/fanli/android/view/MainPage/JustifyTextView;->getLineHeight()I
    ...
    iget v9, p0, Lcom/fanli/android/view/MainPage/JustifyTextView;->mLineY:I
