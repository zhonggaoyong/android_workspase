...
(function() {
			...
			fireDocumentEvent: function(type, data, bNoDetach) {
				...
				if (typeof documentEventHandlers[type] != 'undefined') {
					if (bNoDetach) {
						...
						setTimeout(function() {
							// Fire deviceready on listeners that were registered before snapp.js was loaded.
							if (type == 'deviceready') {
	...
	function(require, exports, module) {
		...
		module.exports = {
			...
			bootstrap: function() {
				...
				var backButtonChannel = snapp.addDocumentEventHandler('backbutton');
	...
	function(require, exports, module) {
		...
		exports.load = function(callback) {
			...
			if (pathPrefix === null) {
				console.log('Could not find snapp.js script tag. Plugin loading may fail.');
				pathPrefix = '';
			}
	...
	function(require, exports, module) {
		...
		utils.prompt = function(msg, value) {
			...
			if (userAgent.match(/SNEBUY-APP?/i)) {
				if(utils.isNewVersion(userAgent)) {
		...
		utils.isNewVersion = function(userAgent) {
        	var result = false;
