...
.method private static a(Lcom/baidu/mapapi/navi/NaviParaOption;)Ljava/lang/String;
    ...
    :cond_0
    const-string/jumbo v1, "latlng:%f,%f"
    ...
    const-string/jumbo v1, "&coord_type=bd09ll"

    invoke-virtual {v0, v1}, Ljava/lang/StringBuffer;->append(Ljava/lang/String;)Ljava/lang/StringBuffer;

    const-string/jumbo v1, "&mode=navigation"

    invoke-virtual {v0, v1}, Ljava/lang/StringBuffer;->append(Ljava/lang/String;)Ljava/lang/StringBuffer;

    const-string/jumbo v1, "#Intent;scheme=bdapp;"

    invoke-virtual {v0, v1}, Ljava/lang/StringBuffer;->append(Ljava/lang/String;)Ljava/lang/StringBuffer;

    const-string/jumbo v1, "package=com.baidu.BaiduMap;"
...
.method public static openBaiduMapNavi(Lcom/baidu/mapapi/navi/NaviParaOption;Landroid/content/Context;)V
    ...
    const-string/jumbo v1, "current baidumap app version not support navigation.Version is greater than 5.0"
