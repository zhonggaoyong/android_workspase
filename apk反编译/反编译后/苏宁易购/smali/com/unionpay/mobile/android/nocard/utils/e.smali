...
.method public static a(Landroid/content/Context;Lcom/unionpay/mobile/android/d/b;)V
    ...
    iget v2, v2, Lcom/unionpay/mobile/android/plugin/d;->a:I
    ...
    iget-object v0, v0, Lcom/unionpay/mobile/android/plugin/d;->f:Ljava/lang/String;
    ...
    iget-object v2, v2, Lcom/unionpay/mobile/android/plugin/d;->f:Ljava/lang/String;
    ...
    :cond_0
    :goto_0
    iget-object v0, p1, Lcom/unionpay/mobile/android/d/b;->P:Ljava/lang/String;
    ...
    iget-boolean v0, p1, Lcom/unionpay/mobile/android/d/b;->O:Z
    ...
    new-instance v3, Lcom/unionpay/mobile/android/nocard/utils/f;

    invoke-direct {v3, v1, v2}, Lcom/unionpay/mobile/android/nocard/utils/f;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v1, " notifyBrowserResult() +++ "
    ...
    iget-object v3, p1, Lcom/unionpay/mobile/android/d/b;->l:Ljava/lang/String;
    ...
    iget-object v3, p1, Lcom/unionpay/mobile/android/d/b;->C:Lcom/unionpay/mobile/android/plugin/d;

    iget v3, v3, Lcom/unionpay/mobile/android/plugin/d;->a:I
    ...
    const-string/jumbo v2, "com.UCMobile.PluginApp.ActivityState"

    invoke-direct {v1, v2}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    const-string/jumbo v2, "ActivityState"
    ...
    const-string/jumbo v2, "com.unionpay.uppay.resultURL"

    invoke-direct {v1, v2}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    const-string/jumbo v2, "uppay"

    const-string/jumbo v3, " uc browser "
    ...
    iget-object v2, v2, Lcom/unionpay/mobile/android/plugin/d;->b:Ljava/lang/String;

    invoke-direct {v1, v2}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    const-string/jumbo v2, "uppay"

    const-string/jumbo v3, " other browser "
    ...
    :cond_4
    const-string/jumbo v2, "ResultURL"
    ...
    const-string/jumbo v1, "notifyAppResult() +++"
    ...
    iget-boolean v1, p1, Lcom/unionpay/mobile/android/d/b;->O:Z

    if-nez v1, :cond_5

    const-string/jumbo v1, "notify_url"

    iget-object v2, p1, Lcom/unionpay/mobile/android/d/b;->P:Ljava/lang/String;

    invoke-virtual {v0, v1, v2}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;

    const-string/jumbo v1, "notify_msg"
    ...
    const-string/jumbo v1, "notifyTencentJarResult() +++"
    ...
    const-string/jumbo v1, "tencentWID"

    iget-object v2, p1, Lcom/unionpay/mobile/android/d/b;->C:Lcom/unionpay/mobile/android/plugin/d;

    iget-object v2, v2, Lcom/unionpay/mobile/android/plugin/d;->h:Ljava/lang/String;

    invoke-virtual {v0, v1, v2}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;

    const-string/jumbo v1, "tencentUID"

    iget-object v2, p1, Lcom/unionpay/mobile/android/d/b;->C:Lcom/unionpay/mobile/android/plugin/d;

    iget-object v2, v2, Lcom/unionpay/mobile/android/plugin/d;->g:Ljava/lang/String;

    invoke-virtual {v0, v1, v2}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;

    const-string/jumbo v1, "bankInfo"

    iget-object v2, p1, Lcom/unionpay/mobile/android/d/b;->C:Lcom/unionpay/mobile/android/plugin/d;

    iget-object v2, v2, Lcom/unionpay/mobile/android/plugin/d;->j:Ljava/lang/String;
    ...
    iget-object v2, v2, Lcom/unionpay/mobile/android/plugin/d;->k:Ljava/lang/String;
    ...
    iget-object v2, v2, Lcom/unionpay/mobile/android/plugin/d;->i:Ljava/lang/String;
