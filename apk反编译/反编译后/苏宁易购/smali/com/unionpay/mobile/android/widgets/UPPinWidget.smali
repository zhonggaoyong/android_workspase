...
# interfaces
.implements Lcom/unionpay/mobile/android/widgets/an;
...
.field private t:Lcom/unionpay/mobile/android/widgets/s;
...
.method public constructor <init>(Landroid/content/Context;ILorg/json/JSONObject;)V
    ...
    invoke-direct {v0, p0}, Lcom/unionpay/mobile/android/widgets/c;-><init>(Lcom/unionpay/mobile/android/widgets/UPPinWidget;)V
    ...
    iput-object v2, p0, Lcom/unionpay/mobile/android/widgets/UPPinWidget;->t:Lcom/unionpay/mobile/android/widgets/s;

    new-instance v0, Lcom/unionpay/mobile/android/widgets/d;

    invoke-direct {v0, p0}, Lcom/unionpay/mobile/android/widgets/d;-><init>(Lcom/unionpay/mobile/android/widgets/UPPinWidget;)V
    ...
    invoke-virtual {p0}, Lcom/unionpay/mobile/android/widgets/UPPinWidget;->e()V
...
.method public constructor <init>(Landroid/content/Context;JILorg/json/JSONObject;)V
    ...
    invoke-direct {p0, p1, p4, p5}, Lcom/unionpay/mobile/android/widgets/at;-><init>(Landroid/content/Context;ILorg/json/JSONObject;)V
...
.method static synthetic a(Lcom/unionpay/mobile/android/widgets/UPPinWidget;)Landroid/view/View;
    ...
    invoke-direct {p0}, Lcom/unionpay/mobile/android/widgets/UPPinWidget;->y()Landroid/view/View;
...
.method static synthetic c(Lcom/unionpay/mobile/android/widgets/UPPinWidget;)V
    ...
    const-string/jumbo v1, "pwdInputFinished() +++"
...
.method private w()V
    ...
    iget-object v0, p0, Lcom/unionpay/mobile/android/widgets/UPPinWidget;->l:Lcom/unionpay/mobile/android/widgets/al;

    invoke-virtual {v0, p0}, Lcom/unionpay/mobile/android/widgets/al;->a(Lcom/unionpay/mobile/android/widgets/an;)V
...
.method private x()V
    ...
    :cond_0
    iget-object v0, p0, Lcom/unionpay/mobile/android/widgets/UPPinWidget;->t:Lcom/unionpay/mobile/android/widgets/s;

    if-eqz v0, :cond_1

    iget-object v0, p0, Lcom/unionpay/mobile/android/widgets/UPPinWidget;->t:Lcom/unionpay/mobile/android/widgets/s;

    invoke-virtual {v0}, Lcom/unionpay/mobile/android/widgets/s;->b()Z
    ...
    invoke-virtual {v0}, Lcom/unionpay/mobile/android/widgets/s;->a()V
...
.method private y()Landroid/view/View;
    ...
    iget-object v0, p0, Lcom/unionpay/mobile/android/widgets/UPPinWidget;->a:Landroid/content/Context;
...
.method public final a(Z)V
    ...
    iget-object v2, p0, Lcom/unionpay/mobile/android/widgets/UPPinWidget;->l:Lcom/unionpay/mobile/android/widgets/al;

    invoke-virtual {v2}, Lcom/unionpay/mobile/android/widgets/al;->getWindowToken()Landroid/os/IBinder;
    ...
    invoke-virtual {p0}, Lcom/unionpay/mobile/android/widgets/UPPinWidget;->h()V
    ...
    :cond_2
    invoke-virtual {p0}, Lcom/unionpay/mobile/android/widgets/UPPinWidget;->c()Z
    ...
    const-string/jumbo v1, "key board is closing.."

    invoke-static {v0, v1}, Lcom/unionpay/mobile/android/h/h;->a(Ljava/lang/String;Ljava/lang/String;)I

    const-string/jumbo v0, "uppay"

    const-string/jumbo v1, "registerKeyboardDissmisslisner() +++"
    ...
    :cond_4
    invoke-direct {p0}, Lcom/unionpay/mobile/android/widgets/UPPinWidget;->x()V
...
.method public final c()Z
    ...
    iget-object v1, p0, Lcom/unionpay/mobile/android/widgets/UPPinWidget;->t:Lcom/unionpay/mobile/android/widgets/s;

    if-eqz v1, :cond_0

    iget-object v1, p0, Lcom/unionpay/mobile/android/widgets/UPPinWidget;->t:Lcom/unionpay/mobile/android/widgets/s;

    invoke-virtual {v1}, Lcom/unionpay/mobile/android/widgets/s;->b()Z
...
.method public final d()V
    ...
    const-string/jumbo v1, "closeCustomKeyboard() +++"
...
.method public final h()V
    ...
    invoke-direct {v0, v1, v2, p0}, Lcom/unionpay/mobile/android/widgets/s;-><init>(Landroid/content/Context;Landroid/view/View$OnClickListener;Landroid/view/View;)V

    iput-object v0, p0, Lcom/unionpay/mobile/android/widgets/UPPinWidget;->t:Lcom/unionpay/mobile/android/widgets/s;

    iget-object v0, p0, Lcom/unionpay/mobile/android/widgets/UPPinWidget;->t:Lcom/unionpay/mobile/android/widgets/s;

    invoke-virtual {v0, p0}, Lcom/unionpay/mobile/android/widgets/s;->a(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v1}, Lcom/unionpay/mobile/android/widgets/al;->b(I)V
...
.method public final i()Z
    ...
    const-string/jumbo v1, "emptyCheck() +++ "
    ...
    const-string/jumbo v2, "mPINCounts =  "
...
.method protected final onDetachedFromWindow()V
    ...
    invoke-super {p0}, Lcom/unionpay/mobile/android/widgets/at;->onDetachedFromWindow()V
