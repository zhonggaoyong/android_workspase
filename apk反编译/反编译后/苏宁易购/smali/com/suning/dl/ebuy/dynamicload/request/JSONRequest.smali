.class public abstract Lcom/suning/dl/ebuy/dynamicload/request/JSONRequest;
.super Lcom/suning/dl/ebuy/dynamicload/request/Request;


# instance fields
.field private mContext:Landroid/content/Context;

.field private mListener:Lcom/suning/mobile/sdk/network/bridge/IHttpListener;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1}, Lcom/suning/dl/ebuy/dynamicload/request/Request;-><init>(Landroid/content/Context;)V

    iput-object p1, p0, Lcom/suning/dl/ebuy/dynamicload/request/JSONRequest;->mContext:Landroid/content/Context;

    const/4 v0, 0x1

    invoke-virtual {p0, v0}, Lcom/suning/dl/ebuy/dynamicload/request/JSONRequest;->enableShowWithoutNetwork(Z)V
...
.method public constructor <init>(Lcom/suning/mobile/sdk/network/bridge/IHttpListener;Landroid/content/Context;)V
    ...
    invoke-direct {p0, p2}, Lcom/suning/dl/ebuy/dynamicload/request/Request;-><init>(Landroid/content/Context;)V

    iput-object p2, p0, Lcom/suning/dl/ebuy/dynamicload/request/JSONRequest;->mContext:Landroid/content/Context;

    iput-object p1, p0, Lcom/suning/dl/ebuy/dynamicload/request/JSONRequest;->mListener:Lcom/suning/mobile/sdk/network/bridge/IHttpListener;
...
.method public constructor <init>(Lcom/suning/mobile/sdk/network/bridge/IHttpListener;ZLandroid/content/Context;)V
    .locals 1

    invoke-direct {p0, p3}, Lcom/suning/dl/ebuy/dynamicload/request/Request;-><init>(Landroid/content/Context;)V

    iput-object p3, p0, Lcom/suning/dl/ebuy/dynamicload/request/JSONRequest;->mContext:Landroid/content/Context;
...
.method private genToken2Cookie(Ljava/lang/String;)Lorg/apache/http/cookie/Cookie;
    .locals 3

    new-instance v0, Lorg/apache/http/impl/cookie/BasicClientCookie;

    const-string/jumbo v1, "ebuyapptoken"

    iget-object v2, p0, Lcom/suning/dl/ebuy/dynamicload/request/JSONRequest;->mContext:Landroid/content/Context;

    invoke-static {v2}, Lcom/suning/d/b/a;->a(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v2

    invoke-direct {v0, v1, v2}, Lorg/apache/http/impl/cookie/BasicClientCookie;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-static {p1}, Lcom/suning/mobile/sdk/network/NetUtils;->obtainDomain(Ljava/lang/String;)Ljava/lang/String;
...
.method public enableShowParserError(Z)V
    ...
    iget-object v0, p0, Lcom/suning/dl/ebuy/dynamicload/request/JSONRequest;->mListener:Lcom/suning/mobile/sdk/network/bridge/IHttpListener;
...
.method protected getParamStr(Ljava/util/List;)Ljava/lang/String;
    .locals 4
...
.method public abstract getPostParams()Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
            "Ljava/util/List",
...
.method protected httpConnect(Z)V
    ...
    invoke-virtual {p0}, Lcom/suning/dl/ebuy/dynamicload/request/JSONRequest;->getPrefix()Ljava/lang/String;

    invoke-virtual {p0}, Lcom/suning/dl/ebuy/dynamicload/request/JSONRequest;->getAction()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/suning/dl/ebuy/dynamicload/request/JSONRequest;->getUrl()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {v3, v0}, Ljava/lang/StringBuffer;->append(Ljava/lang/String;)Ljava/lang/StringBuffer;

    invoke-virtual {p0, v0}, Lcom/suning/dl/ebuy/dynamicload/request/JSONRequest;->setHttpUrl(Ljava/lang/String;)V

    invoke-virtual {p0}, Lcom/suning/dl/ebuy/dynamicload/request/JSONRequest;->getPostParams()Ljava/util/List;
    ...
    invoke-virtual {p0, v6}, Lcom/suning/dl/ebuy/dynamicload/request/JSONRequest;->getParamStr(Ljava/util/List;)Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/suning/dl/ebuy/dynamicload/request/JSONRequest;->mContext:Landroid/content/Context;
    ...
    invoke-direct {p0, v7}, Lcom/suning/dl/ebuy/dynamicload/request/JSONRequest;->genToken2Cookie(Ljava/lang/String;)Lorg/apache/http/cookie/Cookie;

    move-result-object v7

    invoke-virtual {v0, v7}, Lcom/suning/mobile/sdk/network/NetworkManager;->addCookie(Lorg/apache/http/cookie/Cookie;)V
    ...
    invoke-virtual {v0, v7}, Lcom/suning/mobile/sdk/network/NetworkManager;->setCityCode(Ljava/lang/String;)V

    iget-object v0, p0, Lcom/suning/dl/ebuy/dynamicload/request/JSONRequest;->mHttpFactory:Lcom/suning/mobile/sdk/network/core/IHttpConnectionFactory;
    ...
    invoke-virtual {p0, v1}, Lcom/suning/dl/ebuy/dynamicload/request/JSONRequest;->setConnectionProperty(Lcom/suning/mobile/sdk/network/core/ISuningHttpConnection;)V
    ...
    invoke-virtual {p0, v2, v3}, Lcom/suning/dl/ebuy/dynamicload/request/JSONRequest;->notifyFailureWithToast(ILjava/lang/String;)V
    ...
    invoke-virtual {p0, v2, v1}, Lcom/suning/dl/ebuy/dynamicload/request/JSONRequest;->notifyFailureWithToast(ILjava/lang/String;)V
    ...
    :cond_4
    :try_start_6
    invoke-virtual {p0}, Lcom/suning/dl/ebuy/dynamicload/request/JSONRequest;->getEntityCodeFormat()Ljava/lang/String;
    ...
    :goto_3
    invoke-virtual {p0, v0}, Lcom/suning/dl/ebuy/dynamicload/request/JSONRequest;->notifySuccess(Lorg/apache/http/HttpEntity;)V
...
.method protected notifyFailure(ILjava/lang/String;)V
    .locals 2
    ...
    iget-object v1, p0, Lcom/suning/dl/ebuy/dynamicload/request/JSONRequest;->mBindObj:[Ljava/lang/Object;
...
.method protected notifyFailureWithToast(ILjava/lang/String;)V
    .locals 2

    iget-boolean v0, p0, Lcom/suning/dl/ebuy/dynamicload/request/JSONRequest;->enableShowNetworkError:Z
    ...
    :cond_0
    invoke-virtual {p0, p1, p2}, Lcom/suning/dl/ebuy/dynamicload/request/JSONRequest;->notifyFailure(ILjava/lang/String;)V

    return-void
.end method

.method protected notifySuccess(Lorg/apache/http/HttpEntity;)V
    .locals 2
...
.method protected setHttpUrl(Ljava/lang/String;)V
    .locals 1
...
.method public setListener(Lcom/suning/mobile/sdk/network/bridge/IHttpListener;)V
    .locals 0
