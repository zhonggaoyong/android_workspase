.class public Lcom/suning/mobile/paysdk/core/net/CashierBeanRequest;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/suning/mobile/paysdk/core/net/CashierBeanRequest;->PROTOCOL_CONTENT_TYPE:Ljava/lang/String;
...
.method public constructor <init>(ILjava/lang/String;Ljava/lang/String;Lcom/android/volley/x;Lcom/android/volley/w;)V
    ...
    invoke-static {v0, p2}, Lcom/suning/mobile/paysdk/c/b/a;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0}, Lcom/suning/mobile/paysdk/core/net/CashierBeanRequest;->setRetryPolicy(Lcom/android/volley/z;)V
...
.method public constructor <init>(ILjava/lang/String;Ljava/util/Map;Lcom/android/volley/x;Lcom/android/volley/w;)V
    ...
    invoke-static {p3}, Lcom/suning/mobile/paysdk/core/net/CashierBeanRequest;->paramstoString(Ljava/util/Map;)Ljava/lang/String;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/suning/mobile/paysdk/core/net/CashierBeanRequest;-><init>(ILjava/lang/String;Ljava/lang/String;Lcom/android/volley/x;Lcom/android/volley/w;)V
...
.method public constructor <init>(Ljava/lang/String;Ljava/util/List;Lcom/android/volley/x;Lcom/android/volley/w;)V
    ...
    invoke-static {p1, p2}, Lcom/suning/mobile/paysdk/core/net/CashierBeanRequest;->urlBuilder(Ljava/lang/String;Ljava/util/List;)Ljava/lang/String;

    move-result-object v0

    invoke-direct {p0, v0, p3, p4}, Lcom/suning/mobile/paysdk/core/net/CashierBeanRequest;-><init>(Ljava/lang/String;Lcom/android/volley/x;Lcom/android/volley/w;)V
...
.method private exitSDK()V
    ...
    sget-object v0, Lcom/suning/mobile/paysdk/core/SNPay$SDKResult;->NEEDLOGON:Lcom/suning/mobile/paysdk/core/SNPay$SDKResult;
...
.method public getBodyContentType()Ljava/lang/String;
    ...
    sget-object v0, Lcom/suning/mobile/paysdk/core/net/CashierBeanRequest;->PROTOCOL_CONTENT_TYPE:Ljava/lang/String;
...
.method protected parseNetworkResponse(Lcom/android/volley/m;)Lcom/android/volley/v;
    ...
    new-instance v0, Lcom/suning/mobile/paysdk/model/CashierBean;

    invoke-direct {v0}, Lcom/suning/mobile/paysdk/model/CashierBean;-><init>()V

    if-eqz v2, :cond_2

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Lcom/suning/mobile/paysdk/model/CashierBean;->setSuccess(Z)V
    ...
    const-string/jumbo v5, "passport.login.flag"
    ...
    const-string/jumbo v1, "passport need login  "

    invoke-static {v1}, Lcom/suning/mobile/paysdk/c/b/a;->a(Ljava/lang/String;)V

    const/4 v1, 0x1

    invoke-direct {p0}, Lcom/suning/mobile/paysdk/core/net/CashierBeanRequest;->exitSDK()V
    ...
    const-string/jumbo v2, "sdk.session.timeout"
    ...
    invoke-direct {v0, v1}, Lcom/suning/mobile/paysdk/model/CashierBean;-><init>(Lorg/json/JSONObject;)V
    :try_end_0
