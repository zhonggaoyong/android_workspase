...
# instance fields
.field private jW:Landroid/support/v7/internal/widget/ActionBarContextView;

.field private jY:Landroid/support/v7/internal/widget/ScrollingTabContainerView;
...
.field private oC:Landroid/support/v7/internal/widget/ActionBarView$HomeView;

.field private oD:Landroid/support/v7/internal/widget/ActionBarView$HomeView;

.field private oE:Landroid/view/View;

.field private oF:Landroid/support/v7/internal/widget/d;

.field private oG:Landroid/widget/LinearLayout;

.field private oH:Landroid/view/View;

.field public oI:Landroid/support/v7/internal/widget/ProgressBarICS;

.field public oJ:Landroid/support/v7/internal/widget/ProgressBarICS;
...
.field private oS:Landroid/support/v7/internal/view/menu/f;

.field private oT:Landroid/support/v7/internal/view/menu/a;

.field private oU:Landroid/widget/SpinnerAdapter;

.field private oV:Landroid/support/v7/app/ActionBar$b;

.field private oW:Ljava/lang/Runnable;

.field public oX:Landroid/support/v7/internal/widget/ActionBarView$a;

.field oY:Landroid/view/View;

.field oZ:Landroid/view/Window$Callback;

.field private ok:Ljava/lang/CharSequence;

.field private oo:Landroid/widget/LinearLayout;
...
.field private final pa:Landroid/support/v7/internal/widget/c$d;

.field private final pb:Landroid/view/View$OnClickListener;

.field private final pc:Landroid/view/View$OnClickListener;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->oA:I
    ...
    iput-object v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->pa:Landroid/support/v7/internal/widget/c$d;
    ...
    iput-object v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->pb:Landroid/view/View$OnClickListener;
    ...
    iput-object v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->pc:Landroid/view/View$OnClickListener;
    ...
    .line 173
    sget-object v1, Lcom/tencent/mm/a$p;->ActionBar:[I

    sget v2, Lcom/tencent/mm/a$d;->actionBarStyle:I
    ...
    .line 178
    sget v1, Lcom/tencent/mm/a$p;->ActionBar_navigationMode:I

    invoke-virtual {v2, v1, v6}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v1

    iput v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->oz:I

    .line 180
    sget v1, Lcom/tencent/mm/a$p;->ActionBar_title:I

    invoke-virtual {v2, v1}, Landroid/content/res/TypedArray;->getText(I)Ljava/lang/CharSequence;

    move-result-object v1

    iput-object v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->le:Ljava/lang/CharSequence;

    .line 181
    sget v1, Lcom/tencent/mm/a$p;->ActionBar_subtitle:I

    invoke-virtual {v2, v1}, Landroid/content/res/TypedArray;->getText(I)Ljava/lang/CharSequence;

    move-result-object v1

    iput-object v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->ok:Ljava/lang/CharSequence;

    .line 182
    sget v1, Lcom/tencent/mm/a$p;->ActionBar_logo:I

    invoke-virtual {v2, v1}, Landroid/content/res/TypedArray;->getDrawable(I)Landroid/graphics/drawable/Drawable;

    move-result-object v1

    iput-object v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->oB:Landroid/graphics/drawable/Drawable;

    .line 183
    iget-object v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->oB:Landroid/graphics/drawable/Drawable;
    ...
    .line 199
    :cond_1
    sget v1, Lcom/tencent/mm/a$p;->ActionBar_icon:I

    invoke-virtual {v2, v1}, Landroid/content/res/TypedArray;->getDrawable(I)Landroid/graphics/drawable/Drawable;

    move-result-object v1

    iput-object v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->lo:Landroid/graphics/drawable/Drawable;

    .line 200
    iget-object v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->lo:Landroid/graphics/drawable/Drawable;
    ...
    .line 215
    sget v1, Lcom/tencent/mm/a$p;->ActionBar_homeLayout:I

    sget v4, Lcom/tencent/mm/a$k;->abc_action_bar_home:I
    ...
    iput-object v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->oC:Landroid/support/v7/internal/widget/ActionBarView$HomeView;
    ...
    iput-object v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->oD:Landroid/support/v7/internal/widget/ActionBarView$HomeView;

    .line 222
    iget-object v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->oD:Landroid/support/v7/internal/widget/ActionBarView$HomeView;
    ...
    iget-object v4, p0, Landroid/support/v7/internal/widget/ActionBarView;->pb:Landroid/view/View$OnClickListener;
    ...
    sget v5, Lcom/tencent/mm/a$n;->abc_action_bar_up_description:I
    ...
    .line 227
    sget v1, Lcom/tencent/mm/a$p;->ActionBar_titleTextStyle:I

    invoke-virtual {v2, v1, v6}, Landroid/content/res/TypedArray;->getResourceId(II)I

    move-result v1

    iput v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->or:I

    .line 228
    sget v1, Lcom/tencent/mm/a$p;->ActionBar_subtitleTextStyle:I

    invoke-virtual {v2, v1, v6}, Landroid/content/res/TypedArray;->getResourceId(II)I

    move-result v1

    iput v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->os:I

    .line 229
    sget v1, Lcom/tencent/mm/a$p;->ActionBar_progressBarStyle:I

    invoke-virtual {v2, v1, v6}, Landroid/content/res/TypedArray;->getResourceId(II)I

    move-result v1

    iput v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->oM:I

    .line 230
    sget v1, Lcom/tencent/mm/a$p;->ActionBar_indeterminateProgressStyle:I

    invoke-virtual {v2, v1, v6}, Landroid/content/res/TypedArray;->getResourceId(II)I

    move-result v1

    iput v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->oN:I

    .line 233
    sget v1, Lcom/tencent/mm/a$p;->ActionBar_progressBarPadding:I

    invoke-virtual {v2, v1, v6}, Landroid/content/res/TypedArray;->getDimensionPixelOffset(II)I

    move-result v1

    iput v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->oK:I

    .line 235
    sget v1, Lcom/tencent/mm/a$p;->ActionBar_itemPadding:I

    invoke-virtual {v2, v1, v6}, Landroid/content/res/TypedArray;->getDimensionPixelOffset(II)I

    move-result v1

    iput v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->oL:I

    .line 237
    sget v1, Lcom/tencent/mm/a$p;->ActionBar_displayOptions:I
    ...
    .line 239
    sget v1, Lcom/tencent/mm/a$p;->ActionBar_customNavigationLayout:I
    ...
    iput-object v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->oH:Landroid/view/View;

    .line 242
    iput v6, p0, Landroid/support/v7/internal/widget/ActionBarView;->oz:I

    .line 243
    iget v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->oA:I
    ...
    .line 246
    :cond_4
    sget v1, Lcom/tencent/mm/a$p;->ActionBar_height:I
    ...
    iget-object v2, p0, Landroid/support/v7/internal/widget/ActionBarView;->le:Ljava/lang/CharSequence;

    invoke-direct {v1, p1, v2}, Landroid/support/v7/internal/view/menu/a;-><init>(Landroid/content/Context;Ljava/lang/CharSequence;)V

    iput-object v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->oT:Landroid/support/v7/internal/view/menu/a;

    .line 249
    iget-object v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->oC:Landroid/support/v7/internal/widget/ActionBarView$HomeView;

    iget-object v2, p0, Landroid/support/v7/internal/widget/ActionBarView;->pc:Landroid/view/View$OnClickListener;
...
.method static synthetic a(Landroid/support/v7/internal/widget/ActionBarView;)Landroid/support/v7/internal/widget/ActionBarView$a;
    ...
    .prologue
    .line 64
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->oX:Landroid/support/v7/internal/widget/ActionBarView$a;
...
.method static synthetic b(Landroid/support/v7/internal/widget/ActionBarView;)Landroid/support/v7/internal/view/menu/a;
    ...
    .prologue
    .line 64
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->oT:Landroid/support/v7/internal/view/menu/a;
...
.method static synthetic c(Landroid/support/v7/internal/widget/ActionBarView;)Landroid/graphics/drawable/Drawable;
    ...
    .prologue
    .line 64
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->lo:Landroid/graphics/drawable/Drawable;
...
.method private cb()V
    ...
    .line 756
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->oo:Landroid/widget/LinearLayout;
    ...
    .line 758
    sget v3, Lcom/tencent/mm/a$k;->abc_action_bar_title_item:I
    ...
    iput-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->oo:Landroid/widget/LinearLayout;

    .line 760
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->oo:Landroid/widget/LinearLayout;

    sget v3, Lcom/tencent/mm/a$i;->action_bar_title:I
    ...
    iput-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->mo:Landroid/widget/TextView;

    .line 761
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->oo:Landroid/widget/LinearLayout;

    sget v3, Lcom/tencent/mm/a$i;->action_bar_subtitle:I
    ...
    iput-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->oq:Landroid/widget/TextView;

    .line 762
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->oo:Landroid/widget/LinearLayout;

    sget v3, Lcom/tencent/mm/a$i;->up:I

    invoke-virtual {v0, v3}, Landroid/widget/LinearLayout;->findViewById(I)Landroid/view/View;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->oE:Landroid/view/View;

    .line 764
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->oo:Landroid/widget/LinearLayout;

    iget-object v3, p0, Landroid/support/v7/internal/widget/ActionBarView;->pc:Landroid/view/View$OnClickListener;

    invoke-virtual {v0, v3}, Landroid/widget/LinearLayout;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    .line 766
    iget v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->or:I

    if-eqz v0, :cond_0

    .line 767
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->mo:Landroid/widget/TextView;

    iget-object v3, p0, Landroid/support/v7/internal/widget/ActionBarView;->mContext:Landroid/content/Context;

    iget v4, p0, Landroid/support/v7/internal/widget/ActionBarView;->or:I

    invoke-virtual {v0, v3, v4}, Landroid/widget/TextView;->setTextAppearance(Landroid/content/Context;I)V

    .line 769
    :cond_0
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->le:Ljava/lang/CharSequence;
    ...
    iget-object v3, p0, Landroid/support/v7/internal/widget/ActionBarView;->le:Ljava/lang/CharSequence;

    invoke-virtual {v0, v3}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    .line 773
    :cond_1
    iget v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->os:I

    if-eqz v0, :cond_2

    .line 774
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->oq:Landroid/widget/TextView;

    iget-object v3, p0, Landroid/support/v7/internal/widget/ActionBarView;->mContext:Landroid/content/Context;

    iget v4, p0, Landroid/support/v7/internal/widget/ActionBarView;->os:I

    invoke-virtual {v0, v3, v4}, Landroid/widget/TextView;->setTextAppearance(Landroid/content/Context;I)V

    .line 776
    :cond_2
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->ok:Ljava/lang/CharSequence;
    ...
    iget-object v3, p0, Landroid/support/v7/internal/widget/ActionBarView;->ok:Ljava/lang/CharSequence;
    ...
    .line 781
    :cond_3
    iget v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->oA:I
    ...
    .line 782
    :goto_0
    iget v3, p0, Landroid/support/v7/internal/widget/ActionBarView;->oA:I
    ...
    .line 783
    :goto_1
    iget-object v6, p0, Landroid/support/v7/internal/widget/ActionBarView;->oE:Landroid/view/View;
    ...
    .line 784
    iget-object v4, p0, Landroid/support/v7/internal/widget/ActionBarView;->oo:Landroid/widget/LinearLayout;
    ...
    .line 788
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->oY:Landroid/view/View;
...
.method static synthetic d(Landroid/support/v7/internal/widget/ActionBarView;)Landroid/support/v7/internal/widget/ActionBarView$HomeView;
    ...
    .prologue
    .line 64
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->oD:Landroid/support/v7/internal/widget/ActionBarView$HomeView;
...
.method static synthetic e(Landroid/support/v7/internal/widget/ActionBarView;)Landroid/support/v7/internal/widget/ActionBarView$HomeView;
    ...
    .prologue
    .line 64
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->oC:Landroid/support/v7/internal/widget/ActionBarView$HomeView;
...
.method private e(Landroid/support/v7/internal/view/menu/f;)V
    ...
    .line 454
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->nM:Landroid/support/v7/internal/view/menu/ActionMenuPresenter;
...
.method static synthetic g(Landroid/support/v7/internal/widget/ActionBarView;)Landroid/support/v7/internal/widget/ScrollingTabContainerView;
    ...
    .prologue
    .line 64
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->jY:Landroid/support/v7/internal/widget/ScrollingTabContainerView;
...
.method static synthetic h(Landroid/support/v7/internal/widget/ActionBarView;)Landroid/support/v7/internal/widget/d;
    ...
    .prologue
    .line 64
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->oF:Landroid/support/v7/internal/widget/d;
...
.method static synthetic i(Landroid/support/v7/internal/widget/ActionBarView;)Landroid/view/View;
    ...
    .prologue
    .line 64
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->oH:Landroid/view/View;
...
.method static synthetic k(Landroid/support/v7/internal/widget/ActionBarView;)V
    ...
    .prologue
    .line 64
    invoke-direct {p0}, Landroid/support/v7/internal/widget/ActionBarView;->cb()V
...
.method static synthetic l(Landroid/support/v7/internal/widget/ActionBarView;)I
    ...
    .prologue
    .line 64
    iget v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->oz:I
...
.method private setTitleImpl(Ljava/lang/CharSequence;)V
    ...
    .line 518
    iput-object p1, p0, Landroid/support/v7/internal/widget/ActionBarView;->le:Ljava/lang/CharSequence;
    ...
    .line 524
    :goto_0
    iget-object v2, p0, Landroid/support/v7/internal/widget/ActionBarView;->oo:Landroid/widget/LinearLayout;
...
.method public final a(Landroid/support/v4/a/a/a;Landroid/support/v7/internal/view/menu/l$a;)V
    ...
    .line 388
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->oS:Landroid/support/v7/internal/view/menu/f;
    ...
    iget-object v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->nM:Landroid/support/v7/internal/view/menu/ActionMenuPresenter;
    ...
    iget-object v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->oX:Landroid/support/v7/internal/widget/ActionBarView$a;
    ...
    .line 398
    iput-object p1, p0, Landroid/support/v7/internal/widget/ActionBarView;->oS:Landroid/support/v7/internal/view/menu/f;

    .line 399
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->nL:Landroid/support/v7/internal/view/menu/ActionMenuView;
    ...
    .line 402
    iget-object v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->nL:Landroid/support/v7/internal/view/menu/ActionMenuView;
    ...
    iput-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->nM:Landroid/support/v7/internal/view/menu/ActionMenuPresenter;

    .line 407
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->nM:Landroid/support/v7/internal/view/menu/ActionMenuPresenter;

    iput-object p2, v0, Landroid/support/v7/internal/view/menu/b;->me:Landroid/support/v7/internal/view/menu/l$a;

    .line 408
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->nM:Landroid/support/v7/internal/view/menu/ActionMenuPresenter;

    sget v1, Lcom/tencent/mm/a$i;->action_menu_presenter:I

    iput v1, v0, Landroid/support/v7/internal/view/menu/b;->cZ:I
    ...
    iput-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->oX:Landroid/support/v7/internal/widget/ActionBarView$a;
    ...
    .line 415
    iget-boolean v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->nN:Z
    ...
    sget v3, Lcom/tencent/mm/a$e;->abc_action_bar_expanded_action_views_exclusive:I

    invoke-virtual {v1, v3}, Landroid/content/res/Resources;->getBoolean(I)Z

    move-result v1

    iput-boolean v1, v0, Landroid/support/v7/internal/view/menu/ActionMenuPresenter;->lE:Z
    ...
    .line 449
    :goto_1
    iput-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->nL:Landroid/support/v7/internal/view/menu/ActionMenuView;
    ...
    iput-boolean v4, v0, Landroid/support/v7/internal/view/menu/ActionMenuPresenter;->lE:Z
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/internal/view/menu/ActionMenuPresenter;->x(I)V

    .line 432
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->nM:Landroid/support/v7/internal/view/menu/ActionMenuPresenter;

    invoke-virtual {v0}, Landroid/support/v7/internal/view/menu/ActionMenuPresenter;->bw()V
    ...
    .line 437
    iget-object v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->jX:Landroid/support/v7/internal/widget/ActionBarContainer;
    ...
    iget-object v3, p0, Landroid/support/v7/internal/widget/ActionBarView;->jX:Landroid/support/v7/internal/widget/ActionBarContainer;
...
.method public final bridge synthetic bY()V
    .locals 0

    .prologue
    .line 64
    invoke-super {p0}, Landroid/support/v7/internal/widget/a;->bY()V

    return-void
.end method

.method public final bridge synthetic bZ()Z
    .locals 1

    .prologue
    .line 64
    invoke-super {p0}, Landroid/support/v7/internal/widget/a;->bZ()Z
...
.method public getDropdownAdapter()Landroid/widget/SpinnerAdapter;
    ...
    .prologue
    .line 708
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->oU:Landroid/widget/SpinnerAdapter;
...
.method protected onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    .line 259
    iput-object v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->mo:Landroid/widget/TextView;

    .line 260
    iput-object v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->oq:Landroid/widget/TextView;

    .line 261
    iput-object v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->oE:Landroid/view/View;
    ...
    .line 265
    :cond_0
    iput-object v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->oo:Landroid/widget/LinearLayout;
    ...
    iget-boolean v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->oP:Z
...
.method public onDetachedFromWindow()V
    ...
    .line 292
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->oW:Ljava/lang/Runnable;
    ...
    invoke-virtual {v0}, Landroid/support/v7/internal/view/menu/ActionMenuPresenter;->by()Z
...
.method protected onFinishInflate()V
    ...
    iget-object v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->oH:Landroid/view/View;
...
.method protected onLayout(ZIIII)V
    ...
    .line 1021
    :goto_2
    iget-object v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->oY:Landroid/view/View;

    if-nez v1, :cond_3

    .line 1022
    iget-object v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->oo:Landroid/widget/LinearLayout;
    ...
    .line 1029
    :cond_2
    iget v4, p0, Landroid/support/v7/internal/widget/ActionBarView;->oz:I
    ...
    .line 1052
    iget-object v4, p0, Landroid/support/v7/internal/widget/ActionBarView;->nL:Landroid/support/v7/internal/view/menu/ActionMenuView;
    ...
    .line 1057
    :cond_4
    iget-object v4, p0, Landroid/support/v7/internal/widget/ActionBarView;->oJ:Landroid/support/v7/internal/widget/ProgressBarICS;
    ...
    .line 1060
    iget-object v2, p0, Landroid/support/v7/internal/widget/ActionBarView;->oJ:Landroid/support/v7/internal/widget/ProgressBarICS;
    ...
    .line 1064
    iget-object v3, p0, Landroid/support/v7/internal/widget/ActionBarView;->oY:Landroid/view/View;
    ...
    .line 1137
    :cond_6
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->oI:Landroid/support/v7/internal/widget/ProgressBarICS;
    ...
    .line 1143
    iget-object v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->oI:Landroid/support/v7/internal/widget/ProgressBarICS;

    iget v2, p0, Landroid/support/v7/internal/widget/ActionBarView;->oK:I

    neg-int v3, v0

    iget v4, p0, Landroid/support/v7/internal/widget/ActionBarView;->oK:I

    iget-object v5, p0, Landroid/support/v7/internal/widget/ActionBarView;->oI:Landroid/support/v7/internal/widget/ProgressBarICS;
    ...
    .line 1033
    :pswitch_3
    iget-object v4, p0, Landroid/support/v7/internal/widget/ActionBarView;->oG:Landroid/widget/LinearLayout;
    ...
    .line 1035
    iget v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->oL:I

    add-int/2addr v0, v1

    .line 1037
    :cond_9
    iget-object v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->oG:Landroid/widget/LinearLayout;

    invoke-static {v1, v0, v2, v3}, Landroid/support/v7/internal/widget/ActionBarView;->a(Landroid/view/View;III)I

    move-result v1

    iget v4, p0, Landroid/support/v7/internal/widget/ActionBarView;->oL:I
    ...
    .line 1041
    :pswitch_4
    iget-object v4, p0, Landroid/support/v7/internal/widget/ActionBarView;->jY:Landroid/support/v7/internal/widget/ScrollingTabContainerView;
    ...
    .line 1045
    :cond_a
    iget-object v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->jY:Landroid/support/v7/internal/widget/ScrollingTabContainerView;
    ...
    iget-object v3, p0, Landroid/support/v7/internal/widget/ActionBarView;->oH:Landroid/view/View;
...
.method protected onMeasure(II)V
    ...
    iget-boolean v1, v0, Landroid/support/v7/internal/widget/ActionBarView;->oQ:Z
    ...
    iget-object v4, v0, Landroid/support/v7/internal/widget/ActionBarView;->nL:Landroid/support/v7/internal/view/menu/ActionMenuView;

    if-ne v3, v4, :cond_0

    move-object/from16 v0, p0

    iget-object v3, v0, Landroid/support/v7/internal/widget/ActionBarView;->nL:Landroid/support/v7/internal/view/menu/ActionMenuView;
    ...
    iput-boolean v1, v0, Landroid/support/v7/internal/widget/ActionBarView;->oR:Z
    ...
    iget v1, v0, Landroid/support/v7/internal/widget/ActionBarView;->nP:I
    ...
    iget-object v1, v0, Landroid/support/v7/internal/widget/ActionBarView;->oY:Landroid/view/View;

    if-eqz v1, :cond_f

    move-object/from16 v0, p0

    iget-object v1, v0, Landroid/support/v7/internal/widget/ActionBarView;->oD:Landroid/support/v7/internal/widget/ActionBarView$HomeView;
    ...
    iget-object v5, v0, Landroid/support/v7/internal/widget/ActionBarView;->nL:Landroid/support/v7/internal/view/menu/ActionMenuView;
    ...
    iget-object v7, v0, Landroid/support/v7/internal/widget/ActionBarView;->nL:Landroid/support/v7/internal/view/menu/ActionMenuView;
    ...
    iget-object v5, v0, Landroid/support/v7/internal/widget/ActionBarView;->oJ:Landroid/support/v7/internal/widget/ProgressBarICS;
    ...
    iget-object v6, v0, Landroid/support/v7/internal/widget/ActionBarView;->oJ:Landroid/support/v7/internal/widget/ProgressBarICS;
    ...
    iget-object v5, v0, Landroid/support/v7/internal/widget/ActionBarView;->oo:Landroid/widget/LinearLayout;
    ...
    iget v5, v0, Landroid/support/v7/internal/widget/ActionBarView;->oA:I
    ...
    iget-object v6, v0, Landroid/support/v7/internal/widget/ActionBarView;->oY:Landroid/view/View;
    ...
    iget v6, v0, Landroid/support/v7/internal/widget/ActionBarView;->oz:I
    ...
    iget-object v2, v0, Landroid/support/v7/internal/widget/ActionBarView;->oY:Landroid/view/View;
    ...
    iget v9, v0, Landroid/support/v7/internal/widget/ActionBarView;->nP:I
    ...
    iget-object v1, v0, Landroid/support/v7/internal/widget/ActionBarView;->oo:Landroid/widget/LinearLayout;

    move-object/from16 v0, p0

    iget v2, v0, Landroid/support/v7/internal/widget/ActionBarView;->nP:I
    ...
    iget-object v2, v0, Landroid/support/v7/internal/widget/ActionBarView;->oo:Landroid/widget/LinearLayout;
    ...
    iget-object v1, v0, Landroid/support/v7/internal/widget/ActionBarView;->oC:Landroid/support/v7/internal/widget/ActionBarView$HomeView;
    ...
    iget-object v6, v0, Landroid/support/v7/internal/widget/ActionBarView;->oG:Landroid/widget/LinearLayout;
    ...
    iget v6, v0, Landroid/support/v7/internal/widget/ActionBarView;->oL:I
    ...
    iget-object v6, v0, Landroid/support/v7/internal/widget/ActionBarView;->jY:Landroid/support/v7/internal/widget/ScrollingTabContainerView;
    ...
    iget v2, v0, Landroid/support/v7/internal/widget/ActionBarView;->oA:I
    ...
    iget-object v2, v0, Landroid/support/v7/internal/widget/ActionBarView;->oH:Landroid/view/View;
    ...
    iget-object v1, v0, Landroid/support/v7/internal/widget/ActionBarView;->oH:Landroid/view/View;
    ...
    iget-object v1, v0, Landroid/support/v7/internal/widget/ActionBarView;->jW:Landroid/support/v7/internal/widget/ActionBarContextView;
    ...
    iget v2, v0, Landroid/support/v7/internal/widget/ActionBarView;->oK:I
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 1181
    iget v0, p1, Landroid/support/v7/internal/widget/ActionBarView$SavedState;->pj:I
    ...
    iget v1, p1, Landroid/support/v7/internal/widget/ActionBarView$SavedState;->pj:I
    ...
    .line 1190
    :cond_0
    iget-boolean v0, p1, Landroid/support/v7/internal/widget/ActionBarView$SavedState;->pk:Z
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iget-object v0, v0, Landroid/support/v7/internal/widget/ActionBarView$a;->pe:Landroid/support/v7/internal/view/menu/h;
    ...
    iput v0, v1, Landroid/support/v7/internal/widget/ActionBarView$SavedState;->pj:I
    ...
    iput-boolean v0, v1, Landroid/support/v7/internal/widget/ActionBarView$SavedState;->pk:Z
...
.method public setCallback(Landroid/support/v7/app/ActionBar$b;)V
    ...
    .prologue
    .line 384
    iput-object p1, p0, Landroid/support/v7/internal/widget/ActionBarView;->oV:Landroid/support/v7/app/ActionBar$b;
...
.method public setCollapsable(Z)V
    ...
    .prologue
    .line 800
    iput-boolean p1, p0, Landroid/support/v7/internal/widget/ActionBarView;->oQ:Z
...
.method public setContextView(Landroid/support/v7/internal/widget/ActionBarContextView;)V
    ...
    .prologue
    .line 796
    iput-object p1, p0, Landroid/support/v7/internal/widget/ActionBarView;->jW:Landroid/support/v7/internal/widget/ActionBarContextView;
...
.method public setCustomNavigationView(Landroid/view/View;)V
    ...
    .line 484
    :cond_0
    iput-object p1, p0, Landroid/support/v7/internal/widget/ActionBarView;->oH:Landroid/view/View;
...
.method public setDisplayOptions(I)V
    ...
    .line 564
    :goto_0
    iput p1, p0, Landroid/support/v7/internal/widget/ActionBarView;->oA:I
    ...
    .line 569
    :goto_2
    iget-object v6, p0, Landroid/support/v7/internal/widget/ActionBarView;->oC:Landroid/support/v7/internal/widget/ActionBarView$HomeView;
    ...
    .line 602
    iget-object v3, p0, Landroid/support/v7/internal/widget/ActionBarView;->oo:Landroid/widget/LinearLayout;
    ...
    sget v2, Lcom/tencent/mm/a$n;->abc_action_bar_up_description:I
    ...
    sget v2, Lcom/tencent/mm/a$n;->abc_action_bar_home_description:I
...
.method public setDropdownAdapter(Landroid/widget/SpinnerAdapter;)V
    ...
    .prologue
    .line 701
    iput-object p1, p0, Landroid/support/v7/internal/widget/ActionBarView;->oU:Landroid/widget/SpinnerAdapter;
...
.method public setEmbeddedTabView(Landroid/support/v7/internal/widget/ScrollingTabContainerView;)V
    ...
    .line 372
    :cond_0
    iput-object p1, p0, Landroid/support/v7/internal/widget/ActionBarView;->jY:Landroid/support/v7/internal/widget/ScrollingTabContainerView;
    ...
    :goto_0
    iput-boolean v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->oP:Z
...
.method public setHomeAsUpIndicator(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/internal/widget/ActionBarView$HomeView;->C(I)V
...
.method public setHomeAsUpIndicator(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v1, v0, Landroid/support/v7/internal/widget/ActionBarView$HomeView;->pf:Landroid/widget/ImageView;
    ...
    iput v1, v0, Landroid/support/v7/internal/widget/ActionBarView$HomeView;->ph:I
    ...
    .line 1196
    :cond_0
    iget-object p1, v0, Landroid/support/v7/internal/widget/ActionBarView$HomeView;->pi:Landroid/graphics/drawable/Drawable;
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    .prologue
    .line 631
    iput-object p1, p0, Landroid/support/v7/internal/widget/ActionBarView;->lo:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->oB:Landroid/graphics/drawable/Drawable;
...
.method public setLogo(Landroid/graphics/drawable/Drawable;)V
    ...
    .prologue
    .line 646
    iput-object p1, p0, Landroid/support/v7/internal/widget/ActionBarView;->oB:Landroid/graphics/drawable/Drawable;
...
.method public setNavigationMode(I)V
    ...
    :cond_1
    :goto_1
    iput p1, p0, Landroid/support/v7/internal/widget/ActionBarView;->oz:I
    ...
    .line 661
    :pswitch_0
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->oG:Landroid/widget/LinearLayout;
    ...
    sget v2, Lcom/tencent/mm/a$d;->actionDropDownStyle:I

    invoke-direct {v0, v1, v2}, Landroid/support/v7/internal/widget/d;-><init>(Landroid/content/Context;I)V

    iput-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->oF:Landroid/support/v7/internal/widget/d;
    ...
    sget v1, Lcom/tencent/mm/a$k;->abc_action_bar_view_list_nav_layout:I
    ...
    iput-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->oG:Landroid/widget/LinearLayout;
    ...
    iget-object v2, p0, Landroid/support/v7/internal/widget/ActionBarView;->oF:Landroid/support/v7/internal/widget/d;
    ...
    iget-object v0, v0, Landroid/support/v7/internal/widget/AbsSpinnerICS;->nR:Landroid/widget/SpinnerAdapter;

    iget-object v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->oU:Landroid/widget/SpinnerAdapter;
    ...
    iget-object v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->pa:Landroid/support/v7/internal/widget/c$d;

    iput-object v1, v0, Landroid/support/v7/internal/widget/c;->qh:Landroid/support/v7/internal/widget/c$d;
...
.method public setSplitActionBar(Z)V
    ...
    .line 325
    iget-object v2, p0, Landroid/support/v7/internal/widget/ActionBarView;->nL:Landroid/support/v7/internal/view/menu/ActionMenuView;
    ...
    .line 328
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->jX:Landroid/support/v7/internal/widget/ActionBarContainer;
    ...
    .line 339
    iget-object v2, p0, Landroid/support/v7/internal/widget/ActionBarView;->jX:Landroid/support/v7/internal/widget/ActionBarContainer;
    ...
    sget v2, Lcom/tencent/mm/a$e;->abc_action_bar_expanded_action_views_exclusive:I
...
.method public setSubtitle(Ljava/lang/CharSequence;)V
    ...
    .line 536
    iput-object p1, p0, Landroid/support/v7/internal/widget/ActionBarView;->ok:Ljava/lang/CharSequence;
    ...
    .line 539
    iget-object v3, p0, Landroid/support/v7/internal/widget/ActionBarView;->oq:Landroid/widget/TextView;
...
.method public setTitle(Ljava/lang/CharSequence;)V
    ...
    iput-boolean v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->oO:Z
...
.method public setWindowCallback(Landroid/view/Window$Callback;)V
    ...
    .prologue
    .line 286
    iput-object p1, p0, Landroid/support/v7/internal/widget/ActionBarView;->oZ:Landroid/view/Window$Callback;
...
.method public setWindowTitle(Ljava/lang/CharSequence;)V
    ...
    .prologue
    .line 512
    iget-boolean v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->oO:Z
