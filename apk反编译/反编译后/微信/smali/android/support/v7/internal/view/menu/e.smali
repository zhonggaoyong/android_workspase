...
.field public mA:Landroid/support/v7/internal/view/menu/e$a;
...
.field public mx:Landroid/support/v7/internal/view/menu/ExpandedMenuView;
...
.method public constructor <init>(II)V
    ...
    .line 78
    iput p1, p0, Landroid/support/v7/internal/view/menu/e;->mg:I

    .line 79
    iput p2, p0, Landroid/support/v7/internal/view/menu/e;->mz:I
...
.method static synthetic a(Landroid/support/v7/internal/view/menu/e;)I
    ...
    .prologue
    .line 40
    iget v0, p0, Landroid/support/v7/internal/view/menu/e;->my:I
...
.method public final a(Landroid/content/Context;Landroid/support/v7/internal/view/menu/f;)V
    ...
    .prologue
    .line 84
    iget v0, p0, Landroid/support/v7/internal/view/menu/e;->mz:I
    ...
    iget v1, p0, Landroid/support/v7/internal/view/menu/e;->mz:I
    ...
    iput-object v0, p0, Landroid/support/v7/internal/view/menu/e;->iD:Landroid/view/LayoutInflater;

    .line 93
    :cond_0
    :goto_0
    iput-object p2, p0, Landroid/support/v7/internal/view/menu/e;->jG:Landroid/support/v7/internal/view/menu/f;

    .line 94
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/e;->mA:Landroid/support/v7/internal/view/menu/e$a;
    ...
    .line 89
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/e;->iD:Landroid/view/LayoutInflater;
...
.method public final a(Landroid/support/v7/internal/view/menu/f;Z)V
    ...
    .prologue
    .line 157
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/e;->me:Landroid/support/v7/internal/view/menu/l$a;
...
.method public final a(Landroid/support/v7/internal/view/menu/p;)Z
    ...
    invoke-virtual {v0}, Landroid/support/v7/internal/view/menu/g;->bO()V
...
.method public final getAdapter()Landroid/widget/ListAdapter;
    ...
    iput-object v0, p0, Landroid/support/v7/internal/view/menu/e;->mA:Landroid/support/v7/internal/view/menu/e$a;
...
.method public final onItemClick(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    .prologue
    .line 175
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/e;->jG:Landroid/support/v7/internal/view/menu/f;

    iget-object v1, p0, Landroid/support/v7/internal/view/menu/e;->mA:Landroid/support/v7/internal/view/menu/e$a;

    invoke-virtual {v1, p3}, Landroid/support/v7/internal/view/menu/e$a;->z(I)Landroid/support/v7/internal/view/menu/h;
