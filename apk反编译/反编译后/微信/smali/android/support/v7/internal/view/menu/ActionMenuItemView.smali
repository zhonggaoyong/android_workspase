...
.field private lp:Landroid/support/v7/internal/view/menu/f$b;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 66
    sget v1, Lcom/tencent/mm/a$e;->abc_config_allowActionMenuItemTextWithIcon:I

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getBoolean(I)Z

    move-result v0

    iput-boolean v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->lq:Z

    .line 68
    sget-object v0, Lcom/tencent/mm/a$p;->ActionMenuItemView:[I
    ...
    .line 70
    sget v1, Lcom/tencent/mm/a$p;->ActionMenuItemView_android_minWidth:I

    invoke-virtual {v0, v1, v2}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result v1

    iput v1, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->ls:I
    ...
    iput v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->lt:I
...
.method private bt()V
    ...
    .line 135
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->le:Ljava/lang/CharSequence;
    ...
    .line 136
    :goto_0
    iget-object v3, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->lo:Landroid/graphics/drawable/Drawable;

    if-eqz v3, :cond_0

    iget-object v3, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->ln:Landroid/support/v7/internal/view/menu/h;

    iget v3, v3, Landroid/support/v7/internal/view/menu/h;->ne:I
    ...
    iget-boolean v3, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->lq:Z

    if-nez v3, :cond_0

    iget-boolean v3, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->lr:Z
...
.method public final a(Landroid/support/v7/internal/view/menu/h;)V
    ...
    .prologue
    .line 93
    iput-object p1, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->ln:Landroid/support/v7/internal/view/menu/h;
...
.method public final bu()Z
    ...
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->ln:Landroid/support/v7/internal/view/menu/h;
...
.method public onClick(Landroid/view/View;)V
    ...
    .prologue
    .line 104
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->lp:Landroid/support/v7/internal/view/menu/f$b;
    ...
    iget-object v1, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->ln:Landroid/support/v7/internal/view/menu/h;
...
.method public onLongClick(Landroid/view/View;)Z
    ...
    .line 194
    iget-object v9, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->ln:Landroid/support/v7/internal/view/menu/h;
...
.method protected onMeasure(II)V
    ...
    iget v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->lt:I
    ...
    iget v4, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->ls:I
    ...
    iget v2, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->ls:I
    ...
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->lo:Landroid/graphics/drawable/Drawable;
    ...
    .line 233
    iget-object v1, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->lo:Landroid/graphics/drawable/Drawable;
    ...
    .line 220
    :cond_3
    iget v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->ls:I
...
.method public setExpandedFormat(Z)V
    ...
    .prologue
    .line 126
    iget-boolean v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->lr:Z

    if-eq v0, p1, :cond_0

    .line 127
    iput-boolean p1, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->lr:Z
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 143
    iput-object p1, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->lo:Landroid/graphics/drawable/Drawable;
    ...
    .line 146
    invoke-direct {p0}, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->bt()V
...
.method public setItemInvoker(Landroid/support/v7/internal/view/menu/f$b;)V
    ...
    .prologue
    .line 110
    iput-object p1, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->lp:Landroid/support/v7/internal/view/menu/f$b;
...
.method public setPadding(IIII)V
    ...
    .prologue
    .line 84
    iput p1, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->lt:I
...
.method public setTitle(Ljava/lang/CharSequence;)V
    ...
    .prologue
    .line 158
    iput-object p1, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->le:Ljava/lang/CharSequence;
