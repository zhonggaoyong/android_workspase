...
# instance fields
.field gu:Ljava/util/ArrayList;

.field final mContext:Landroid/content/Context;

.field final mE:Landroid/content/res/Resources;

.field private mF:Z

.field private mG:Z

.field mH:Landroid/support/v7/internal/view/menu/f$a;
...
.field private mO:Landroid/view/ContextMenu$ContextMenuInfo;

.field mP:Ljava/lang/CharSequence;

.field mQ:Landroid/graphics/drawable/Drawable;

.field mR:Landroid/view/View;
...
.field private mX:Ljava/util/concurrent/CopyOnWriteArrayList;

.field mY:Landroid/support/v7/internal/view/menu/h;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/internal/view/menu/f;->mD:[I
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 115
    iput v1, p0, Landroid/support/v7/internal/view/menu/f;->mN:I

    .line 143
    iput-boolean v1, p0, Landroid/support/v7/internal/view/menu/f;->mS:Z

    .line 145
    iput-boolean v1, p0, Landroid/support/v7/internal/view/menu/f;->mT:Z

    .line 147
    iput-boolean v1, p0, Landroid/support/v7/internal/view/menu/f;->mU:Z

    .line 149
    iput-boolean v1, p0, Landroid/support/v7/internal/view/menu/f;->mV:Z
    ...
    iput-object v2, p0, Landroid/support/v7/internal/view/menu/f;->mW:Ljava/util/ArrayList;
    ...
    iput-object v2, p0, Landroid/support/v7/internal/view/menu/f;->mX:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    iput-object v2, p0, Landroid/support/v7/internal/view/menu/f;->mE:Landroid/content/res/Resources;
    ...
    iput-object v2, p0, Landroid/support/v7/internal/view/menu/f;->gu:Ljava/util/ArrayList;
    ...
    iput-object v2, p0, Landroid/support/v7/internal/view/menu/f;->mK:Ljava/util/ArrayList;
    ...
    iput-object v2, p0, Landroid/support/v7/internal/view/menu/f;->mL:Ljava/util/ArrayList;

    .line 204
    iput-boolean v0, p0, Landroid/support/v7/internal/view/menu/f;->mM:Z

    .line 206
    iget-object v2, p0, Landroid/support/v7/internal/view/menu/f;->mE:Landroid/content/res/Resources;
    ...
    sget v3, Lcom/tencent/mm/a$e;->abc_config_showMenuShortcutsWhenKeyboardPresent:I
...
.method private static a(Ljava/util/ArrayList;I)I
    ...
    .line 793
    iget v0, v0, Landroid/support/v7/internal/view/menu/h;->ld:I
...
.method private a(ILandroid/view/KeyEvent;)Landroid/support/v7/internal/view/menu/h;
    ...
    .line 872
    iget-object v5, p0, Landroid/support/v7/internal/view/menu/f;->mW:Ljava/util/ArrayList;
    ...
    .line 891
    :cond_2
    invoke-virtual {p0}, Landroid/support/v7/internal/view/menu/f;->bF()Z
...
.method private a(IIILjava/lang/CharSequence;)Landroid/view/MenuItem;
    ...
    sget-object v1, Landroid/support/v7/internal/view/menu/f;->mD:[I
    ...
    iget v7, p0, Landroid/support/v7/internal/view/menu/f;->mN:I
    ...
    .line 406
    iget-object v1, p0, Landroid/support/v7/internal/view/menu/f;->mO:Landroid/view/ContextMenu$ContextMenuInfo;
    ...
    iput-object v1, v0, Landroid/support/v7/internal/view/menu/h;->nj:Landroid/view/ContextMenu$ContextMenuInfo;

    .line 411
    :cond_2
    iget-object v1, p0, Landroid/support/v7/internal/view/menu/f;->gu:Ljava/util/ArrayList;

    iget-object v2, p0, Landroid/support/v7/internal/view/menu/f;->gu:Ljava/util/ArrayList;

    invoke-static {v2, v5}, Landroid/support/v7/internal/view/menu/f;->a(Ljava/util/ArrayList;I)I
...
.method private a(Ljava/util/List;ILandroid/view/KeyEvent;)V
    ...
    .line 837
    :cond_1
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/f;->gu:Ljava/util/ArrayList;
...
.method public a(Landroid/support/v7/internal/view/menu/f$a;)V
    ...
    .prologue
    .line 394
    iput-object p1, p0, Landroid/support/v7/internal/view/menu/f;->mH:Landroid/support/v7/internal/view/menu/f$a;
...
.method public final a(Landroid/support/v7/internal/view/menu/l;)V
    ...
    .prologue
    .line 221
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/f;->mX:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method final a(Ljava/lang/CharSequence;Landroid/graphics/drawable/Drawable;Landroid/view/View;)V
    ...
    .line 1158
    iput-object p3, p0, Landroid/support/v7/internal/view/menu/f;->mR:Landroid/view/View;

    .line 1161
    iput-object v0, p0, Landroid/support/v7/internal/view/menu/f;->mP:Ljava/lang/CharSequence;

    .line 1162
    iput-object v0, p0, Landroid/support/v7/internal/view/menu/f;->mQ:Landroid/graphics/drawable/Drawable;
    ...
    .line 1167
    iput-object p1, p0, Landroid/support/v7/internal/view/menu/f;->mP:Ljava/lang/CharSequence;
    ...
    .line 1173
    iput-object p2, p0, Landroid/support/v7/internal/view/menu/f;->mQ:Landroid/graphics/drawable/Drawable;

    .line 1177
    :cond_2
    iput-object v0, p0, Landroid/support/v7/internal/view/menu/f;->mR:Landroid/view/View;
...
.method a(Landroid/support/v7/internal/view/menu/f;Landroid/view/MenuItem;)Z
    ...
    .prologue
    .line 778
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/f;->mH:Landroid/support/v7/internal/view/menu/f$a;
...
.method public add(I)Landroid/view/MenuItem;
    ...
    .line 424
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/f;->mE:Landroid/content/res/Resources;
...
.method public final b(Landroid/support/v7/internal/view/menu/l;)V
    ...
    .line 236
    :cond_1
    iget-object v1, p0, Landroid/support/v7/internal/view/menu/f;->mX:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method bF()Z
    ...
    .prologue
    .line 737
    iget-boolean v0, p0, Landroid/support/v7/internal/view/menu/f;->mF:Z
...
.method public final bH()V
    ...
    iput-boolean v0, p0, Landroid/support/v7/internal/view/menu/f;->mT:Z
...
.method public final bI()V
    ...
    .line 1021
    iget-boolean v0, p0, Landroid/support/v7/internal/view/menu/f;->mT:Z
...
.method final bK()Ljava/util/ArrayList;
    .locals 5
    ...
    .line 1062
    iget-object v4, p0, Landroid/support/v7/internal/view/menu/f;->mI:Ljava/util/ArrayList;
    ...
    .line 1066
    :cond_2
    iput-boolean v2, p0, Landroid/support/v7/internal/view/menu/f;->mJ:Z
...
.method public final bL()V
    ...
    .line 1097
    iget-boolean v0, p0, Landroid/support/v7/internal/view/menu/f;->mM:Z
    ...
    .line 1108
    :cond_1
    invoke-interface {v1}, Landroid/support/v7/internal/view/menu/l;->bz()Z
    ...
    .line 1113
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/f;->mK:Ljava/util/ArrayList;

    invoke-virtual {v0}, Ljava/util/ArrayList;->clear()V

    .line 1114
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/f;->mL:Ljava/util/ArrayList;

    invoke-virtual {v0}, Ljava/util/ArrayList;->clear()V

    .line 1115
    invoke-virtual {p0}, Landroid/support/v7/internal/view/menu/f;->bK()Ljava/util/ArrayList;
    ...
    .line 1119
    invoke-virtual {v0}, Landroid/support/v7/internal/view/menu/h;->bS()Z
    ...
    .line 1120
    iget-object v5, p0, Landroid/support/v7/internal/view/menu/f;->mK:Ljava/util/ArrayList;
    ...
    .line 1122
    :cond_3
    iget-object v5, p0, Landroid/support/v7/internal/view/menu/f;->mL:Ljava/util/ArrayList;
    ...
    .line 1132
    :cond_5
    iput-boolean v3, p0, Landroid/support/v7/internal/view/menu/f;->mM:Z

    goto :goto_0
.end method

.method final bM()Ljava/util/ArrayList;
    .locals 1

    .prologue
    .line 1141
    invoke-virtual {p0}, Landroid/support/v7/internal/view/menu/f;->bL()V
...
.method public bN()Landroid/support/v7/internal/view/menu/f;
    .locals 0
...
.method public final c(Landroid/view/MenuItem;I)Z
    ...
    .line 923
    :cond_2
    invoke-virtual {p1}, Landroid/support/v7/internal/view/menu/h;->bP()Z
    ...
    .line 940
    iget-object v2, p0, Landroid/support/v7/internal/view/menu/f;->mX:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public clear()V
    ...
    .prologue
    .line 548
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/f;->mY:Landroid/support/v7/internal/view/menu/h;
...
.method public f(Landroid/support/v7/internal/view/menu/h;)Z
    ...
    .line 1297
    :goto_2
    invoke-virtual {p0}, Landroid/support/v7/internal/view/menu/f;->bI()V

    .line 1302
    if-eqz v0, :cond_0

    .line 1303
    iput-object p1, p0, Landroid/support/v7/internal/view/menu/f;->mY:Landroid/support/v7/internal/view/menu/h;
...
.method public g(Landroid/support/v7/internal/view/menu/h;)Z
    ...
    iget-object v1, p0, Landroid/support/v7/internal/view/menu/f;->mY:Landroid/support/v7/internal/view/menu/h;
    ...
    iput-object v1, p0, Landroid/support/v7/internal/view/menu/f;->mY:Landroid/support/v7/internal/view/menu/h;
...
.method final r(Z)V
    ...
    .prologue
    .line 965
    iget-boolean v0, p0, Landroid/support/v7/internal/view/menu/f;->mV:Z
    ...
    iput-boolean v0, p0, Landroid/support/v7/internal/view/menu/f;->mV:Z
...
.method public removeGroup(I)V
    ...
    .line 505
    invoke-direct {p0, v3, v1}, Landroid/support/v7/internal/view/menu/f;->c(IZ)V
...
.method public removeItem(I)V
    ...
    invoke-direct {p0, v0, v1}, Landroid/support/v7/internal/view/menu/f;->c(IZ)V
...
.method final s(Z)V
    ...
    .line 997
    iput-boolean v1, p0, Landroid/support/v7/internal/view/menu/f;->mM:Z
...
.method public setQwertyMode(Z)V
    ...
    .prologue
    .line 708
    iput-boolean p1, p0, Landroid/support/v7/internal/view/menu/f;->mF:Z
