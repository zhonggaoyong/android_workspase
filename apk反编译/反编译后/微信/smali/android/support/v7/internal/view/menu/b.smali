...
.field protected iD:Landroid/view/LayoutInflater;

.field protected jG:Landroid/support/v7/internal/view/menu/f;

.field protected mContext:Landroid/content/Context;

.field protected mc:Landroid/content/Context;

.field protected md:Landroid/view/LayoutInflater;

.field public me:Landroid/support/v7/internal/view/menu/l$a;

.field private mf:I

.field private mg:I

.field protected mh:Landroid/support/v7/internal/view/menu/m;
...
.method public constructor <init>(Landroid/content/Context;II)V
    ...
    .line 57
    iput-object p1, p0, Landroid/support/v7/internal/view/menu/b;->mc:Landroid/content/Context;
    ...
    iput-object v0, p0, Landroid/support/v7/internal/view/menu/b;->md:Landroid/view/LayoutInflater;

    .line 59
    iput p2, p0, Landroid/support/v7/internal/view/menu/b;->mf:I

    .line 60
    iput p3, p0, Landroid/support/v7/internal/view/menu/b;->mg:I
...
.method public a(Landroid/support/v7/internal/view/menu/h;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 178
    :cond_0
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/b;->md:Landroid/view/LayoutInflater;

    iget v1, p0, Landroid/support/v7/internal/view/menu/b;->mg:I
...
.method public a(Landroid/content/Context;Landroid/support/v7/internal/view/menu/f;)V
    ...
    iput-object v0, p0, Landroid/support/v7/internal/view/menu/b;->iD:Landroid/view/LayoutInflater;

    .line 67
    iput-object p2, p0, Landroid/support/v7/internal/view/menu/b;->jG:Landroid/support/v7/internal/view/menu/f;
...
.method public a(Landroid/support/v7/internal/view/menu/f;Z)V
    ...
    .prologue
    .line 204
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/b;->me:Landroid/support/v7/internal/view/menu/l$a;
...
.method public b(Landroid/view/ViewGroup;)Landroid/support/v7/internal/view/menu/m;
    ...
    .prologue
    .line 71
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/b;->mh:Landroid/support/v7/internal/view/menu/m;
    ...
    iget v1, p0, Landroid/support/v7/internal/view/menu/b;->mf:I
    ...
    iput-object v0, p0, Landroid/support/v7/internal/view/menu/b;->mh:Landroid/support/v7/internal/view/menu/m;

    .line 73
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/b;->mh:Landroid/support/v7/internal/view/menu/m;

    iget-object v1, p0, Landroid/support/v7/internal/view/menu/b;->jG:Landroid/support/v7/internal/view/menu/f;
...
.method public q(Z)V
    ...
    invoke-virtual {v1}, Landroid/support/v7/internal/view/menu/f;->bL()V

    .line 92
    iget-object v1, p0, Landroid/support/v7/internal/view/menu/b;->jG:Landroid/support/v7/internal/view/menu/f;

    invoke-virtual {v1}, Landroid/support/v7/internal/view/menu/f;->bK()Ljava/util/ArrayList;
    ...
    :cond_3
    iget-object v1, p0, Landroid/support/v7/internal/view/menu/b;->mh:Landroid/support/v7/internal/view/menu/m;
