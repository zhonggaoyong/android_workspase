...
.field private jS:Landroid/support/v7/internal/widget/ActionBarOverlayLayout;

.field private jT:Landroid/support/v7/internal/widget/ActionBarContainer;

.field private jU:Landroid/view/ViewGroup;

.field private jV:Landroid/support/v7/internal/widget/ActionBarView;

.field private jW:Landroid/support/v7/internal/widget/ActionBarContextView;

.field private jX:Landroid/support/v7/internal/widget/ActionBarContainer;

.field private jY:Landroid/support/v7/internal/widget/ScrollingTabContainerView;

.field private jZ:I

.field private jy:Landroid/support/v7/app/ActionBarActivity;
...
.field private kk:Landroid/support/v7/app/ActionBar$a;
...
.method public constructor <init>(Landroid/support/v7/app/ActionBarActivity;Landroid/support/v7/app/ActionBar$a;)V
    ...
    iput-object v0, p0, Landroid/support/v7/app/e;->cO:Ljava/util/ArrayList;

    .line 73
    const/4 v0, -0x1

    iput v0, p0, Landroid/support/v7/app/e;->jZ:I
    ...
    iput-object v0, p0, Landroid/support/v7/app/e;->kb:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Landroid/support/v7/app/e;->mHandler:Lcom/tencent/mm/sdk/platformtools/z;

    .line 96
    iput v2, p0, Landroid/support/v7/app/e;->ke:I

    .line 102
    iput-boolean v1, p0, Landroid/support/v7/app/e;->ki:Z

    .line 108
    iput-object p1, p0, Landroid/support/v7/app/e;->jy:Landroid/support/v7/app/ActionBarActivity;

    .line 109
    iput-object p1, p0, Landroid/support/v7/app/e;->mContext:Landroid/content/Context;

    .line 110
    iput-object p2, p0, Landroid/support/v7/app/e;->kk:Landroid/support/v7/app/ActionBar$a;

    .line 111
    iget-object v3, p0, Landroid/support/v7/app/e;->jy:Landroid/support/v7/app/ActionBarActivity;
    ...
    iput-object v0, p0, Landroid/support/v7/app/e;->jS:Landroid/support/v7/internal/widget/ActionBarOverlayLayout;

    iget-object v0, p0, Landroid/support/v7/app/e;->jS:Landroid/support/v7/internal/widget/ActionBarOverlayLayout;
    ...
    iput-object v0, p0, Landroid/support/v7/app/e;->jV:Landroid/support/v7/internal/widget/ActionBarView;
    ...
    iput-object v0, p0, Landroid/support/v7/app/e;->jW:Landroid/support/v7/internal/widget/ActionBarContextView;
    ...
    iput-object v0, p0, Landroid/support/v7/app/e;->jT:Landroid/support/v7/internal/widget/ActionBarContainer;
    ...
    iput-object v0, p0, Landroid/support/v7/app/e;->jU:Landroid/view/ViewGroup;

    iget-object v0, p0, Landroid/support/v7/app/e;->jU:Landroid/view/ViewGroup;

    if-nez v0, :cond_1

    iget-object v0, p0, Landroid/support/v7/app/e;->jT:Landroid/support/v7/internal/widget/ActionBarContainer;
    ...
    iput-object v0, p0, Landroid/support/v7/app/e;->jX:Landroid/support/v7/internal/widget/ActionBarContainer;

    iget-object v0, p0, Landroid/support/v7/app/e;->jV:Landroid/support/v7/internal/widget/ActionBarView;

    if-eqz v0, :cond_2

    iget-object v0, p0, Landroid/support/v7/app/e;->jW:Landroid/support/v7/internal/widget/ActionBarContextView;
    ...
    iget-object v3, p0, Landroid/support/v7/app/e;->jW:Landroid/support/v7/internal/widget/ActionBarContextView;
    ...
    :goto_0
    iput v0, p0, Landroid/support/v7/app/e;->kc:I
    ...
    iput-boolean v1, p0, Landroid/support/v7/app/e;->ka:Z

    :cond_4
    iget-object v3, p0, Landroid/support/v7/app/e;->mContext:Landroid/content/Context;

    invoke-static {v3}, Landroid/support/v7/internal/view/a;->g(Landroid/content/Context;)Landroid/support/v7/internal/view/a;
    ...
    iget-object v0, p0, Landroid/support/v7/app/e;->jy:Landroid/support/v7/app/ActionBarActivity;

    invoke-virtual {v0}, Landroid/support/v7/app/ActionBarActivity;->getTitle()Ljava/lang/CharSequence;

    move-result-object v0

    iget-object v1, p0, Landroid/support/v7/app/e;->jV:Landroid/support/v7/internal/widget/ActionBarView;
...
.method final bm()V
    ...
    .line 961
    iget-boolean v2, p0, Landroid/support/v7/app/e;->kf:Z

    iget-boolean v3, p0, Landroid/support/v7/app/e;->kg:Z

    iget-boolean v4, p0, Landroid/support/v7/app/e;->kh:Z
    ...
    .line 964
    iget-boolean v2, p0, Landroid/support/v7/app/e;->ki:Z

    if-nez v2, :cond_3

    .line 965
    iput-boolean v0, p0, Landroid/support/v7/app/e;->ki:Z

    .line 966
    iget-object v2, p0, Landroid/support/v7/app/e;->jU:Landroid/view/ViewGroup;
    ...
    invoke-virtual {p0}, Landroid/support/v7/app/e;->bn()Z
    ...
    iget-object v3, p0, Landroid/support/v7/app/e;->jU:Landroid/view/ViewGroup;
    ...
    iget-object v2, p0, Landroid/support/v7/app/e;->jX:Landroid/support/v7/internal/widget/ActionBarContainer;
    ...
    :cond_2
    iget-object v0, p0, Landroid/support/v7/app/e;->jX:Landroid/support/v7/internal/widget/ActionBarContainer;
    ...
    :cond_7
    iget-object v1, p0, Landroid/support/v7/app/e;->jU:Landroid/view/ViewGroup;

    invoke-virtual {v1, v5}, Landroid/view/ViewGroup;->setVisibility(I)V

    iget-object v1, p0, Landroid/support/v7/app/e;->jX:Landroid/support/v7/internal/widget/ActionBarContainer;
...
.method bn()Z
    ...
    .prologue
    .line 1034
    iget-boolean v0, p0, Landroid/support/v7/app/e;->kj:Z
...
.method public final getThemedContext()Landroid/content/Context;
    ...
    .prologue
    .line 503
    iget-object v0, p0, Landroid/support/v7/app/e;->jR:Landroid/content/Context;
    ...
    iput-object v1, p0, Landroid/support/v7/app/e;->jR:Landroid/content/Context;
    ...
    iput-object v0, p0, Landroid/support/v7/app/e;->jR:Landroid/content/Context;
...
.method public hide()V
    ...
    .prologue
    .line 540
    iget-boolean v0, p0, Landroid/support/v7/app/e;->kf:Z
    ...
    iput-boolean v0, p0, Landroid/support/v7/app/e;->kf:Z

    .line 542
    invoke-virtual {p0}, Landroid/support/v7/app/e;->bm()V
...
.method public final isShowing()Z
    ...
    .prologue
    .line 555
    iget-boolean v0, p0, Landroid/support/v7/app/e;->ki:Z
...
.method final o(Z)V
    ...
    .line 156
    iput-boolean p1, p0, Landroid/support/v7/app/e;->kd:Z

    .line 158
    iget-boolean v0, p0, Landroid/support/v7/app/e;->kd:Z
    ...
    iget-object v3, p0, Landroid/support/v7/app/e;->jY:Landroid/support/v7/internal/widget/ScrollingTabContainerView;
    ...
    :cond_0
    :goto_2
    iget-object v3, p0, Landroid/support/v7/app/e;->jV:Landroid/support/v7/internal/widget/ActionBarView;

    iget-boolean v4, p0, Landroid/support/v7/app/e;->kd:Z
...
.method public final p(Z)V
    ...
    .prologue
    .line 977
    iput-boolean p1, p0, Landroid/support/v7/app/e;->kj:Z
...
.method public final setDisplayOptions(I)V
    ...
    iput-boolean v0, p0, Landroid/support/v7/app/e;->ka:Z
