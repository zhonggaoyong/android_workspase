...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, Landroid/support/v4/view/PagerTabStrip;->fH:Landroid/graphics/Paint;
    ...
    iput-object v0, p0, Landroid/support/v4/view/PagerTabStrip;->fI:Landroid/graphics/Rect;
    ...
    .line 66
    iput-boolean v4, p0, Landroid/support/v4/view/PagerTabStrip;->fK:Z

    .line 67
    iput-boolean v4, p0, Landroid/support/v4/view/PagerTabStrip;->fL:Z

    .line 82
    iget v0, p0, Landroid/support/v4/view/PagerTabStrip;->gh:I

    iput v0, p0, Landroid/support/v4/view/PagerTabStrip;->fB:I

    .line 83
    iget-object v0, p0, Landroid/support/v4/view/PagerTabStrip;->fH:Landroid/graphics/Paint;

    iget v1, p0, Landroid/support/v4/view/PagerTabStrip;->fB:I
    ...
    iput v1, p0, Landroid/support/v4/view/PagerTabStrip;->fC:I
    ...
    iput v1, p0, Landroid/support/v4/view/PagerTabStrip;->fM:I
    ...
    iput v0, p0, Landroid/support/v4/view/PagerTabStrip;->fQ:I
    ...
    .line 102
    iget-object v0, p0, Landroid/support/v4/view/PagerTabStrip;->fT:Landroid/widget/TextView;
    ...
    .line 119
    iput-boolean v5, p0, Landroid/support/v4/view/PagerTabStrip;->fK:Z
...
.method final a(IFZ)V
    ...
    .prologue
    .line 277
    iget-object v0, p0, Landroid/support/v4/view/PagerTabStrip;->fI:Landroid/graphics/Rect;
    ...
    .line 279
    iget-object v2, p0, Landroid/support/v4/view/PagerTabStrip;->fU:Landroid/widget/TextView;

    invoke-virtual {v2}, Landroid/widget/TextView;->getLeft()I

    move-result v2

    iget v3, p0, Landroid/support/v4/view/PagerTabStrip;->fG:I

    sub-int/2addr v2, v3

    .line 280
    iget-object v3, p0, Landroid/support/v4/view/PagerTabStrip;->fU:Landroid/widget/TextView;
    ...
    iput v2, p0, Landroid/support/v4/view/PagerTabStrip;->fJ:I
    ...
    iget v5, p0, Landroid/support/v4/view/PagerTabStrip;->fG:I
...
.method public getDrawFullUnderline()Z
    ...
    .prologue
    .line 210
    iget-boolean v0, p0, Landroid/support/v4/view/PagerTabStrip;->fK:Z
...
.method public getTabIndicatorColor()I
    ...
    .prologue
    .line 147
    iget v0, p0, Landroid/support/v4/view/PagerTabStrip;->fB:I
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    .line 262
    iget-object v1, p0, Landroid/support/v4/view/PagerTabStrip;->fU:Landroid/widget/TextView;

    invoke-virtual {v1}, Landroid/widget/TextView;->getRight()I

    move-result v1

    iget v2, p0, Landroid/support/v4/view/PagerTabStrip;->fG:I
    ...
    .line 265
    iget-object v1, p0, Landroid/support/v4/view/PagerTabStrip;->fH:Landroid/graphics/Paint;

    iget v4, p0, Landroid/support/v4/view/PagerTabStrip;->fJ:I

    shl-int/lit8 v4, v4, 0x18

    iget v5, p0, Landroid/support/v4/view/PagerTabStrip;->fB:I
    ...
    iget-object v5, p0, Landroid/support/v4/view/PagerTabStrip;->fH:Landroid/graphics/Paint;
    ...
    iget v2, p0, Landroid/support/v4/view/PagerTabStrip;->fB:I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-boolean v3, p0, Landroid/support/v4/view/PagerTabStrip;->fN:Z
    ...
    .line 231
    :pswitch_0
    iput v3, p0, Landroid/support/v4/view/PagerTabStrip;->fO:F

    .line 232
    iput v4, p0, Landroid/support/v4/view/PagerTabStrip;->fP:F

    .line 233
    iput-boolean v0, p0, Landroid/support/v4/view/PagerTabStrip;->fN:Z

    goto :goto_1

    .line 237
    :pswitch_1
    iget v0, p0, Landroid/support/v4/view/PagerTabStrip;->fO:F
    ...
    iget v2, p0, Landroid/support/v4/view/PagerTabStrip;->fQ:I
    ...
    .line 239
    :cond_2
    iput-boolean v1, p0, Landroid/support/v4/view/PagerTabStrip;->fN:Z
    ...
    .line 245
    iget-object v0, p0, Landroid/support/v4/view/PagerTabStrip;->fS:Landroid/support/v4/view/ViewPager;

    iget-object v2, p0, Landroid/support/v4/view/PagerTabStrip;->fS:Landroid/support/v4/view/ViewPager;
...
.method public setBackgroundColor(I)V
    ...
    :goto_0
    iput-boolean v0, p0, Landroid/support/v4/view/PagerTabStrip;->fK:Z
...
.method public setDrawFullUnderline(Z)V
    ...
    .prologue
    .line 197
    iput-boolean p1, p0, Landroid/support/v4/view/PagerTabStrip;->fK:Z
...
.method public setPadding(IIII)V
    ...
    .prologue
    .line 152
    iget v0, p0, Landroid/support/v4/view/PagerTabStrip;->fD:I

    if-ge p4, v0, :cond_0

    .line 153
    iget p4, p0, Landroid/support/v4/view/PagerTabStrip;->fD:I
...
.method public setTabIndicatorColor(I)V
    ...
    .prologue
    .line 129
    iput p1, p0, Landroid/support/v4/view/PagerTabStrip;->fB:I
...
.method public setTextSpacing(I)V
    ...
    .line 161
    iget p1, p0, Landroid/support/v4/view/PagerTabStrip;->fE:I
