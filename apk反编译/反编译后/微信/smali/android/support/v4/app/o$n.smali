...
.method public final b(Landroid/support/v4/app/o$d;)Landroid/app/Notification;
    ...
    iget-object v2, v0, Landroid/support/v4/app/o$d;->dR:Landroid/app/Notification;

    move-object/from16 v0, p1

    iget-object v3, v0, Landroid/support/v4/app/o$d;->dt:Ljava/lang/CharSequence;

    move-object/from16 v0, p1

    iget-object v4, v0, Landroid/support/v4/app/o$d;->du:Ljava/lang/CharSequence;

    move-object/from16 v0, p1

    iget-object v5, v0, Landroid/support/v4/app/o$d;->dz:Ljava/lang/CharSequence;

    move-object/from16 v0, p1

    iget-object v6, v0, Landroid/support/v4/app/o$d;->dx:Landroid/widget/RemoteViews;

    move-object/from16 v0, p1

    iget v7, v0, Landroid/support/v4/app/o$d;->dA:I

    move-object/from16 v0, p1

    iget-object v8, v0, Landroid/support/v4/app/o$d;->dv:Landroid/app/PendingIntent;

    move-object/from16 v0, p1

    iget-object v9, v0, Landroid/support/v4/app/o$d;->dw:Landroid/app/PendingIntent;

    move-object/from16 v0, p1

    iget-object v10, v0, Landroid/support/v4/app/o$d;->dy:Landroid/graphics/Bitmap;

    move-object/from16 v0, p1

    iget v11, v0, Landroid/support/v4/app/o$d;->dF:I

    move-object/from16 v0, p1

    iget v12, v0, Landroid/support/v4/app/o$d;->dG:I

    move-object/from16 v0, p1

    iget-boolean v13, v0, Landroid/support/v4/app/o$d;->dH:Z
