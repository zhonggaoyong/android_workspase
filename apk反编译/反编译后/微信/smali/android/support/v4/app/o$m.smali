...
.method public final b(Landroid/support/v4/app/o$d;)Landroid/app/Notification;
    ...
    iget-object v1, p1, Landroid/support/v4/app/o$d;->dR:Landroid/app/Notification;

    iget-object v2, p1, Landroid/support/v4/app/o$d;->dt:Ljava/lang/CharSequence;

    iget-object v3, p1, Landroid/support/v4/app/o$d;->du:Ljava/lang/CharSequence;

    iget-object v4, p1, Landroid/support/v4/app/o$d;->dz:Ljava/lang/CharSequence;

    iget-object v5, p1, Landroid/support/v4/app/o$d;->dx:Landroid/widget/RemoteViews;

    iget v6, p1, Landroid/support/v4/app/o$d;->dA:I

    iget-object v7, p1, Landroid/support/v4/app/o$d;->dv:Landroid/app/PendingIntent;

    iget-object v8, p1, Landroid/support/v4/app/o$d;->dw:Landroid/app/PendingIntent;

    iget-object v9, p1, Landroid/support/v4/app/o$d;->dy:Landroid/graphics/Bitmap;
