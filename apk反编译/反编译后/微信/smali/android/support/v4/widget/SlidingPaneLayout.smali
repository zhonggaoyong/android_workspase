...
# static fields
.field static final iU:Landroid/support/v4/widget/SlidingPaneLayout$e;
...
.field private iQ:Landroid/support/v4/widget/SlidingPaneLayout$d;

.field private final iR:Landroid/support/v4/widget/f;

.field private iS:Z

.field private final iT:Ljava/util/ArrayList;

.field private final il:Landroid/graphics/Rect;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/widget/SlidingPaneLayout;->iU:Landroid/support/v4/widget/SlidingPaneLayout$e;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput v0, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iG:I

    .line 182
    iput-boolean v4, p0, Landroid/support/v4/widget/SlidingPaneLayout;->he:Z
    ...
    iput-object v0, p0, Landroid/support/v4/widget/SlidingPaneLayout;->il:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iT:Ljava/util/ArrayList;
    ...
    iput v1, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iJ:I
    ...
    iput-object v1, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iR:Landroid/support/v4/widget/f;

    .line 265
    iget-object v1, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iR:Landroid/support/v4/widget/f;

    iput v4, v1, Landroid/support/v4/widget/f;->jp:I
...
.method private B(Landroid/view/View;)V
    ...
    .prologue
    .line 991
    sget-object v0, Landroid/support/v4/widget/SlidingPaneLayout;->iU:Landroid/support/v4/widget/SlidingPaneLayout$e;
...
.method static synthetic a(Landroid/support/v4/widget/SlidingPaneLayout;I)V
    ...
    .prologue
    .line 88
    iget-object v0, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iL:Landroid/view/View;
    ...
    iget v2, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iO:I

    int-to-float v2, v2

    div-float/2addr v1, v2

    iput v1, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iM:F

    iget v1, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iP:I

    if-eqz v1, :cond_0

    iget v1, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iM:F
    ...
    iget v2, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iG:I
...
.method private a(Landroid/view/View;FI)V
    ...
    .line 931
    iget-object v2, v0, Landroid/support/v4/widget/SlidingPaneLayout$LayoutParams;->iZ:Landroid/graphics/Paint;
    ...
    iput-object v2, v0, Landroid/support/v4/widget/SlidingPaneLayout$LayoutParams;->iZ:Landroid/graphics/Paint;
    ...
    .line 936
    iget-object v0, v0, Landroid/support/v4/widget/SlidingPaneLayout$LayoutParams;->iZ:Landroid/graphics/Paint;
    ...
    .line 940
    iget-object v1, v0, Landroid/support/v4/widget/SlidingPaneLayout$LayoutParams;->iZ:Landroid/graphics/Paint;
    ...
    .line 944
    iget-object v1, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iT:Ljava/util/ArrayList;
...
.method static synthetic a(Landroid/support/v4/widget/SlidingPaneLayout;Z)Z
    ...
    .prologue
    .line 88
    iput-boolean p1, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iS:Z
...
.method private aY()Z
    ...
    .line 828
    iget-boolean v1, p0, Landroid/support/v4/widget/SlidingPaneLayout;->he:Z
    ...
    .line 829
    :cond_0
    iput-boolean v0, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iS:Z
...
.method static synthetic b(Landroid/support/v4/widget/SlidingPaneLayout;)Landroid/support/v4/widget/f;
    ...
    .prologue
    .line 88
    iget-object v0, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iR:Landroid/support/v4/widget/f;
...
.method static synthetic c(Landroid/support/v4/widget/SlidingPaneLayout;)F
    ...
    .prologue
    .line 88
    iget v0, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iM:F
...
.method static synthetic e(Landroid/support/v4/widget/SlidingPaneLayout;)I
    ...
    .prologue
    .line 88
    iget v0, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iO:I
...
.method static synthetic f(Landroid/support/v4/widget/SlidingPaneLayout;)Ljava/util/ArrayList;
    ...
    .prologue
    .line 88
    iget-object v0, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iT:Ljava/util/ArrayList;
...
.method private g(F)Z
    ...
    .line 1001
    iget-boolean v0, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iK:Z
    ...
    .line 1011
    iget-object v2, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iR:Landroid/support/v4/widget/f;

    iget-object v3, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iL:Landroid/view/View;

    iget-object v4, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iL:Landroid/view/View;
    ...
    .line 1012
    invoke-virtual {p0}, Landroid/support/v4/widget/SlidingPaneLayout;->aX()V
...
.method private h(F)V
    ...
    .line 1072
    iget-boolean v2, v0, Landroid/support/v4/widget/SlidingPaneLayout$LayoutParams;->iY:Z
    ...
    .line 1078
    iget v4, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iN:F

    sub-float v4, v7, v4

    iget v5, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iP:I
    ...
    .line 1079
    iput p1, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iN:F

    .line 1080
    sub-float v5, v7, p1

    iget v6, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iP:I
    ...
    iget v5, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iH:I
...
.method final C(Landroid/view/View;)Z
    ...
    .line 1130
    iget-boolean v2, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iK:Z
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iI:Landroid/graphics/drawable/Drawable;
    ...
    .line 1066
    iget-object v4, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iI:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v4, v1, v3, v2, v0}, Landroid/graphics/drawable/Drawable;->setBounds(IIII)V

    .line 1067
    iget-object v0, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iI:Landroid/graphics/drawable/Drawable;
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    .line 955
    iget-boolean v3, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iK:Z

    if-eqz v3, :cond_0

    iget-boolean v3, v0, Landroid/support/v4/widget/SlidingPaneLayout$LayoutParams;->iX:Z
    ...
    .line 957
    iget-object v3, p0, Landroid/support/v4/widget/SlidingPaneLayout;->il:Landroid/graphics/Rect;
    ...
    iget-object v4, p0, Landroid/support/v4/widget/SlidingPaneLayout;->il:Landroid/graphics/Rect;

    iget v4, v4, Landroid/graphics/Rect;->right:I

    iget-object v5, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iL:Landroid/view/View;
    ...
    .line 963
    iget-boolean v3, v0, Landroid/support/v4/widget/SlidingPaneLayout$LayoutParams;->iY:Z

    if-eqz v3, :cond_4

    iget v3, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iM:F
...
.method public getCoveredFadeColor()I
    ...
    .prologue
    .line 320
    iget v0, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iH:I
...
.method public getParallaxDistance()I
    ...
    .prologue
    .line 287
    iget v0, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iP:I
...
.method public getSliderFadeColor()I
    ...
    .prologue
    .line 303
    iget v0, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iG:I
...
.method protected onAttachedToWindow()V
    ...
    iput-boolean v0, p0, Landroid/support/v4/widget/SlidingPaneLayout;->he:Z
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 781
    :goto_2
    iget-object v3, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iR:Landroid/support/v4/widget/f;
    ...
    .line 757
    iput v0, p0, Landroid/support/v4/widget/SlidingPaneLayout;->fO:F

    .line 758
    iput v3, p0, Landroid/support/v4/widget/SlidingPaneLayout;->fP:F
    ...
    .line 770
    iget v4, p0, Landroid/support/v4/widget/SlidingPaneLayout;->fO:F
    ...
    .line 771
    iget v4, p0, Landroid/support/v4/widget/SlidingPaneLayout;->fP:F
    ...
    .line 772
    iget-object v4, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iR:Landroid/support/v4/widget/f;
...
.method protected onLayout(ZIIII)V
    ...
    .line 647
    iget-boolean v0, p0, Landroid/support/v4/widget/SlidingPaneLayout;->he:Z
    ...
    iget-boolean v0, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iS:Z
    ...
    :goto_0
    iput v0, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iM:F
    ...
    .line 665
    iget-boolean v1, v0, Landroid/support/v4/widget/SlidingPaneLayout$LayoutParams;->iX:Z
    ...
    iget v13, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iJ:I
    ...
    .line 669
    iput v12, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iO:I
    ...
    :goto_2
    iput-boolean v1, v0, Landroid/support/v4/widget/SlidingPaneLayout$LayoutParams;->iY:Z

    .line 672
    int-to-float v1, v12

    iget v12, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iM:F
    ...
    iget v3, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iG:I
...
.method protected onMeasure(II)V
    ...
    iput-object v2, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iL:Landroid/view/View;
    ...
    iput-boolean v3, v0, Landroid/support/v4/widget/SlidingPaneLayout$LayoutParams;->iY:Z
    ...
    :goto_6
    iput-boolean v3, v0, Landroid/support/v4/widget/SlidingPaneLayout$LayoutParams;->iX:Z

    or-int/2addr v3, v6

    .line 539
    iget-boolean v0, v0, Landroid/support/v4/widget/SlidingPaneLayout$LayoutParams;->iX:Z

    if-eqz v0, :cond_6

    .line 540
    iput-object v12, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iL:Landroid/view/View;
    ...
    .line 546
    :cond_d
    iget v0, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iJ:I
    ...
    .line 630
    iput-boolean v6, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iK:Z

    .line 631
    iget-object v0, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iR:Landroid/support/v4/widget/f;

    iget v0, v0, Landroid/support/v4/widget/f;->jd:I
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 1170
    iget-boolean v0, p1, Landroid/support/v4/widget/SlidingPaneLayout$SavedState;->ja:Z
    ...
    .line 1173
    :cond_2
    invoke-direct {p0}, Landroid/support/v4/widget/SlidingPaneLayout;->aY()Z
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    :goto_0
    iput-boolean v0, v1, Landroid/support/v4/widget/SlidingPaneLayout$SavedState;->ja:Z
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 802
    iput v1, p0, Landroid/support/v4/widget/SlidingPaneLayout;->fP:F
    ...
    .line 810
    iget v2, p0, Landroid/support/v4/widget/SlidingPaneLayout;->fO:F

    sub-float v2, v0, v2

    .line 811
    iget v3, p0, Landroid/support/v4/widget/SlidingPaneLayout;->fP:F
    ...
    iget-object v2, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iL:Landroid/view/View;
...
.method public setCoveredFadeColor(I)V
    ...
    .prologue
    .line 313
    iput p1, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iH:I
...
.method public setPanelSlideListener(Landroid/support/v4/widget/SlidingPaneLayout$d;)V
    ...
    .prologue
    .line 324
    iput-object p1, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iQ:Landroid/support/v4/widget/SlidingPaneLayout$d;
...
.method public setParallaxDistance(I)V
    ...
    .prologue
    .line 277
    iput p1, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iP:I
...
.method public setShadowDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    .prologue
    .line 1038
    iput-object p1, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iI:Landroid/graphics/drawable/Drawable;
...
.method public setSliderFadeColor(I)V
    ...
    .prologue
    .line 296
    iput p1, p0, Landroid/support/v4/widget/SlidingPaneLayout;->iG:I
