.class public final Lcom/unionpay/mobile/android/nocard/views/ab;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/unionpay/mobile/android/nocard/views/ab;->p:Landroid/widget/TextView;

    new-instance v0, Lcom/unionpay/mobile/android/nocard/views/ac;

    invoke-direct {v0, p0}, Lcom/unionpay/mobile/android/nocard/views/ac;-><init>(Lcom/unionpay/mobile/android/nocard/views/ab;)V

    iput-object v0, p0, Lcom/unionpay/mobile/android/nocard/views/ab;->q:Landroid/view/View$OnClickListener;

    const/16 v0, 0xb

    iput v0, p0, Lcom/unionpay/mobile/android/nocard/views/ab;->f:I

    invoke-virtual {p0}, Lcom/unionpay/mobile/android/nocard/views/ab;->a()Landroid/widget/RelativeLayout;

    move-result-object v0

    iput-object v0, p0, Lcom/unionpay/mobile/android/nocard/views/ab;->j:Landroid/widget/RelativeLayout;

    invoke-virtual {p0}, Lcom/unionpay/mobile/android/nocard/views/ab;->b()V

    invoke-super {p0}, Lcom/unionpay/mobile/android/nocard/views/b;->d()V

    invoke-virtual {p0}, Lcom/unionpay/mobile/android/nocard/views/ab;->c()V

    return-void
.end method

.method static synthetic a(Lcom/unionpay/mobile/android/nocard/views/ab;)V
    .locals 0

    invoke-direct {p0}, Lcom/unionpay/mobile/android/nocard/views/ab;->r()V
...
.method private r()V
    ...
    iget-object v0, p0, Lcom/unionpay/mobile/android/nocard/views/ab;->a:Lcom/unionpay/mobile/android/model/b;
    ...
    invoke-virtual {p0}, Lcom/unionpay/mobile/android/nocard/views/ab;->k()V
...
.method public final a(Lorg/json/JSONObject;)V
    ...
    invoke-virtual {p0}, Lcom/unionpay/mobile/android/nocard/views/ab;->j()V
    ...
    invoke-virtual {p0, v0}, Lcom/unionpay/mobile/android/nocard/views/ab;->b(I)V
    ...
    invoke-virtual {p0, v0}, Lcom/unionpay/mobile/android/nocard/views/ab;->d(I)V
...
.method protected final b()V
    ...
    invoke-virtual {p0}, Lcom/unionpay/mobile/android/nocard/views/ab;->getContext()Landroid/content/Context;

    move-result-object v2

    iget-object v3, p0, Lcom/unionpay/mobile/android/nocard/views/ab;->a:Lcom/unionpay/mobile/android/model/b;
    ...
    iget-object v2, p0, Lcom/unionpay/mobile/android/nocard/views/ab;->j:Landroid/widget/RelativeLayout;
...
.method protected final c()V
    ...
    iget-object v2, p0, Lcom/unionpay/mobile/android/nocard/views/ab;->d:Landroid/content/Context;
    ...
    iget-object v3, p0, Lcom/unionpay/mobile/android/nocard/views/ab;->d:Landroid/content/Context;
    ...
    iget-object v3, p0, Lcom/unionpay/mobile/android/nocard/views/ab;->l:Landroid/widget/RelativeLayout;
    ...
    iget-object v1, p0, Lcom/unionpay/mobile/android/nocard/views/ab;->l:Landroid/widget/RelativeLayout;

    invoke-virtual {v1, v2, v0}, Landroid/widget/RelativeLayout;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V

    new-instance v0, Landroid/widget/TextView;

    iget-object v1, p0, Lcom/unionpay/mobile/android/nocard/views/ab;->d:Landroid/content/Context;
    ...
    iget-object v1, p0, Lcom/unionpay/mobile/android/nocard/views/ab;->a:Lcom/unionpay/mobile/android/model/b;
    ...
    iget-object v0, p0, Lcom/unionpay/mobile/android/nocard/views/ab;->p:Landroid/widget/TextView;
    ...
    invoke-static {v6, v1, v3, v4}, Lcom/unionpay/mobile/android/utils/d;->a(IIII)Landroid/content/res/ColorStateList;
    ...
    iget-object v1, p0, Lcom/unionpay/mobile/android/nocard/views/ab;->q:Landroid/view/View$OnClickListener;

    invoke-virtual {v0, v1}, Landroid/widget/TextView;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    sget v0, Lcom/unionpay/mobile/android/global/a;->n:I

    iget-object v1, p0, Lcom/unionpay/mobile/android/nocard/views/ab;->c:Lcom/unionpay/mobile/android/resource/c;
    ...
    iget-object v3, p0, Lcom/unionpay/mobile/android/nocard/views/ab;->p:Landroid/widget/TextView;
    ...
    iget-object v0, p0, Lcom/unionpay/mobile/android/nocard/views/ab;->l:Landroid/widget/RelativeLayout;

    iget-object v2, p0, Lcom/unionpay/mobile/android/nocard/views/ab;->p:Landroid/widget/TextView;
